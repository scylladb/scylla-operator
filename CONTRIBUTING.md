...
Never include [keywords that close issues](https://docs.github.com/en/issues/tracking-your-work-with-issues/using-issues/linking-a-pull-request-to-an-issue) in the commit messages - GitHub acts on them when the commit lands on the default branch, whichever PR carries it. Put them in the PR description instead. Plain `#1234` references and `@mentions` are fine as context.
