...
We follow [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) for all commit messages and PR merge messages.
...
scope: optional, short module/component

subject: imperative, lowercase, ≤72 chars, no trailing period

Keep in mind:
- Use **BREAKING CHANGE: description** in the body for breaking changes
- Reference issues with #<number> in the commit footer or PR body (if applicable)
- Keep messages concise and meaningful
- Squash/merge commits must preserve a Conventional Commit as the final message
- Adhering to this makes history readable and enables automated changelogs and releases

PR example: `feat(scyllacluster): add new XYZ field to ScyllaCluster CRD`

```
**Description of your changes:**
feat(scyllacluster): add new XYZ field to ScyllaCluster CRD
