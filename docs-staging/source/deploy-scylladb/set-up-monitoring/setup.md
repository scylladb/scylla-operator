...
[`ScyllaDBMonitoring`](../../reference/api/index.md) custom resource and an external `Prometheus` instance.
...
see the [`ScyllaDBMonitoring` API reference](../../reference/api/index.md).
