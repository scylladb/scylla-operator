...
ScyllaDB Operator provides the [`ScyllaDBMonitoring`](../reference/api/index.md) custom resource
...
`ServiceMonitor` and `PrometheusRule` resources created by ScyllaDB Operator. Please refer to the [Setting up ScyllaDB Monitoring](../deploy-scylladb/set-up-monitoring/setup.md#deploy-prometheus-instance) guide for more details.
...
Please refer to the [`ScyllaDBMonitoring` API reference](../reference/api/index.md) for details.
