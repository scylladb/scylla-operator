...
Always verify that your [ScyllaCluster](/tutorials/day0/create-cluster.md) resource specifications meat [all the criteria](https://kubernetes.io/docs/concepts/workloads/pods/pod-qos/#criteria).
