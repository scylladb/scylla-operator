...
.. list-table::
   ...
   * - :ref:`prometheus<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus>`
     - object
...
.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus:

.spec.components.grafana.datasources[].prometheus
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - Property
     - Type
     - Description
   * - :ref:`auth<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.auth>`
     - object
     - auth holds authentication options for connecting to Prometheus.
   * - :ref:`tls<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.tls>`
     - object
     - tls holds TLS configuration for connecting to Prometheus over HTTPS.

.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.auth:

.spec.components.grafana.datasources[].prometheus.auth
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - Property
     - Type
     - Description
   * - :ref:`bearerTokenOptions<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.auth.bearerTokenOptions>`
     - object
...
.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.auth.bearerTokenOptions:

.spec.components.grafana.datasources[].prometheus.auth.bearerTokenOptions
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - Property
     - Type
     - Description
   * - :ref:`secretRef<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.auth.bearerTokenOptions.secretRef>`
     - object
     - secretRef is a reference to a key in a Secret holding a Bearer token to use to authenticate with Prometheus.

.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.auth.bearerTokenOptions.secretRef:

.spec.components.grafana.datasources[].prometheus.auth.bearerTokenOptions.secretRef
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.tls:

.spec.components.grafana.datasources[].prometheus.tls
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - Property
     - Type
     - Description
   * - :ref:`caCertConfigMapRef<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.tls.caCertConfigMapRef>`
     - object
   ...
   * - :ref:`clientTLSKeyPairSecretRef<api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.tls.clientTLSKeyPairSecretRef>`
     - object
...
.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.tls.caCertConfigMapRef:

.spec.components.grafana.datasources[].prometheus.tls.caCertConfigMapRef
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. _api-scylla.scylladb.com-scylladbmonitorings-v1alpha1-.spec.components.grafana.datasources[].prometheus.tls.clientTLSKeyPairSecretRef:

.spec.components.grafana.datasources[].prometheus.tls.clientTLSKeyPairSecretRef
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - mode
     - string
     - mode fined the mode of the Prometheus instance.
