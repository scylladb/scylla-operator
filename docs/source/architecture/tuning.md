...
Performance tuning is enabled when you create a [NodeConfig](../deploying/node-configuration.md) resource that targets your ScyllaDB nodes.
...
For a step-by-step guide on configuring CPU pinning, see [CPU Pinning](../deploying/cpu-pinning.md).
