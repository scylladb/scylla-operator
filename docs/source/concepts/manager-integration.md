...
[Backup](#api-scylla.scylladb.com-scyllaclusters-v1-.spec.backups[]) and [repair](#api-scylla.scylladb.com-scyllaclusters-v1-.spec.repairs[]) tasks are configured for each [ScyllaCluster](../reference/api/groups/scylla.scylladb.com/scyllaclusters.rst) in its resource definition.

## Manual restore procedure

You can find more detail on how to perform the manual restore procedure in [this dedicated page](../operations/backup-and-restore/restore-from-backup.md). 
