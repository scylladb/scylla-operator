...
Setting up the RAID arrays, formatting the file system or mounting it in a declarative manner is challenging and that's one of the reasons we have created the [NodeConfig](../installation/nodeconfigs-old.md) custom resource.
