...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "hack", ".venv", "_snippets"]
...
DEPRECATED_VERSIONS = ["v1.17", "v1.18"]
...
# The sphinx_scylladb_theme already registers grid/topic-box/hero-box directives.
# Do not load sphinx_design explicitly to avoid conflicts.
# Suppress cosmetic warnings from the theme's grid directive not recognizing
# all sphinx-design options used in the landing page.
suppress_warnings = ["myst.directive_option", "design.grid"]
