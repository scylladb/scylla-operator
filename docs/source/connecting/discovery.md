...
- [Connecting via CQL](cql.md) — using the discovery endpoint for CQL connections.
- [External access](external-access.md) — configuring expose options for external connectivity.
- [Networking architecture](../architecture/networking.md) — how Services and expose options work.
