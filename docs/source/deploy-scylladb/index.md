...
The reference deployment guides link to [Before you deploy](before-you-deploy/index.md) for node preparation steps — you do not need to follow those pages separately.
