...
For production access via Ingress, see [Exposing Grafana](exposing-grafana.md).

## Related pages

- [Exposing Grafana](exposing-grafana.md) — configuring Ingress for Grafana.
- [Operator configuration](operator-configuration.md) — Grafana and Prometheus image settings.
- [Production checklist](production-checklist.md) — monitoring as a production requirement.
- [Prerequisites](../installation/prerequisites.md) — Prometheus Operator dependency.
