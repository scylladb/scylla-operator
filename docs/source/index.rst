...
For the latest status of the project, and reports issue, see the `Github Project <https://github.com/scylladb/scylla-operator>`. Also check out the K8s Operator lesson on Scylla University.
