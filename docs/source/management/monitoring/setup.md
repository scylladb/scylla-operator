...
In the Managed mode, you can configure various aspects of the Prometheus instance that will be deployed for you.
...
In the External mode, you need to ensure that your existing Prometheus instance is configured to discover and scrape the
...
If you use the `Managed` Prometheus mode, no additional configuration is needed. `ScyllaDBMonitoring` will automatically configure
