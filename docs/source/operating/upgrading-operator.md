...
2. Check the [compatibility matrix](../installation/prerequisites.md) to confirm the target Operator version supports your Kubernetes and ScyllaDB versions.
...
| Dependency | Notes |
|---|---|
| cert-manager | Check the [prerequisites](../installation/prerequisites.md) for the required version. |
...
- [Prerequisites](../installation/prerequisites.md) — version compatibility matrix
- [Installing via Helm](../installation/helm.md) — initial installation procedure
- [Upgrading ScyllaDB](upgrading-scylladb.md) — upgrading the ScyllaDB version itself
