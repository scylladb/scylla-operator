...
- [StatefulSets and racks](../architecture/statefulsets-and-racks.md) — partition-based rollout mechanics
- [Rolling restart](rolling-restart.md) — restarting all nodes without changing the ScyllaDB version
- [Replacing nodes](replacing-nodes.md) — replacing a specific node after a failed upgrade
