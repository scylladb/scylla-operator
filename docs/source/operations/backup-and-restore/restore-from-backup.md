...
This procedure will describe how to restore from backup taken using [ScyllaDB Manager](../../concepts/manager-integration.md) to a fresh **empty** cluster of any size.
