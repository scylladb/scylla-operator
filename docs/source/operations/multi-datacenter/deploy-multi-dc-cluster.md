...
For details of ScyllaDB cluster deployments and their configuration, see the [ScyllaCluster resource documentation](../../tutorials/day0/create-cluster.md).
:::
...
- [Build multiple Amazon EKS clusters with Inter-Kubernetes networking](multi-dc-eks.md)
- [Build multiple GKE clusters with Inter-Kubernetes networking](multi-dc-gke.md)
...
However, other configuration options allow for the manual deployment of multi-datacenter ScyllaDB clusters in different network setups. For details, refer to [Exposing ScyllaClusters](../networking/expose-clusters.md) in ScyllaDB Operator documentation.
...
To deploy ScyllaDB Manager, follow the steps described in [Deploying ScyllaDB Manager on a Kubernetes Cluster](../../concepts/manager-integration.md)
...
To deploy ScyllaDB Monitoring, follow the steps described in [ScyllaDB Monitoring setup](../monitoring/setup.md) in ScyllaDB Operator documentation.
