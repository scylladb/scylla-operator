...
Refer to [Creating an EKS cluster](../../get-started/eks.md#creating-an-eks-cluster) section of ScyllaDB Operator documentation for the reference of the configuration of node groups.
