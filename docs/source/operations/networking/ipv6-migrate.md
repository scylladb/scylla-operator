...
Before making any changes, ensure you have recent backups. See [Configuring backup tasks](../../concepts/manager-integration.md#configuring-backup-and-repair-tasks-for-a-scyllacluster) for details on setting up backups for your ScyllaCluster.
...
Create a backup before proceeding. See [Configuring backup tasks](../../concepts/manager-integration.md#configuring-backup-and-repair-tasks-for-a-scyllacluster) for details on setting up backups for your ScyllaCluster.
...
For more troubleshooting steps, see [Troubleshoot IPv6 issues](../../troubleshooting/ipv6-troubleshoot.md).
...
- [Troubleshoot IPv6 issues](../../troubleshooting/ipv6-troubleshoot.md)
...
- [Troubleshoot IPv6 networking](../../troubleshooting/ipv6-troubleshoot.md)
