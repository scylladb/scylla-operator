...
However, as we are not able to reliably keep them up to date at all times, always consult the {{ '[configuration files in the source branch of your ScyllaDB release](https://github.com/scylladb/scylladb/tree/scylla-{}/dist/common/sysctl.d)'.format(scyllaDBImageTag) }} before you configure your cluster.
:::
...
:::{tip}
You can learn more about the NodeConfig resource in the [NodeConfig tutorial](../installation/nodeconfigs-old.md) and the [generated API reference](../reference/api/groups/scylla.scylladb.com/nodeconfigs.rst).
:::
