...
:::{code-block} bash
kubectl wait --for='condition=Progressing=False' scylladbcluster.scylla.scylladb.com/scylladb
kubectl wait --for='condition=Degraded=False' scylladbcluster.scylla.scylladb.com/scylladb
kubectl wait --for='condition=Available=True' scylladbcluster.scylla.scylladb.com/scylladb
:::
