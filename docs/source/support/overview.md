...
ScyllaDB Operator contains an embedded tool called [must-gather](../troubleshooting/must-gather.md) that can collect the required information for requesting support or reporting issues.
