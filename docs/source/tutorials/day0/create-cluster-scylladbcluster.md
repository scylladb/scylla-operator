...
- [Build multiple Amazon EKS clusters with Inter-Kubernetes networking](../../operations/multi-datacenter/multi-dc-eks.md)
- [Build multiple GKE clusters with Inter-Kubernetes networking](../../operations/multi-datacenter/multi-dc-gke.md)

```{image} ../../operations/multi-datacenter/remotekubernetesclusters.svg
...
We recommend reviewing our [tuning architecture documentation](../../concepts/performance-and-tuning.md) and becoming familiar with the [NodeConfig resource](../../installation/nodeconfigs-old.md).  
...
Refer to the [RemoteKubernetesCluster documentation](../../operations/multi-datacenter/remotekubernetesclusters.md) for instructions on setting up credentials.  
