...
To deploy a ScyllaDB cluster with multiple datacenters use our multi datacenter resource [ScyllaDBCluster](create-cluster-scylladbcluster.md), or combine multiple Kubernetes clusters, each running a [ScyllaCluster](../../reference/api/groups/scylla.scylladb.com/scyllaclusters.rst),
To learn more about **manual** multi-dc deployments using ScyllaCluster resource, please see [the dedicated multi-datacenter guide](../../operations/multi-datacenter/deploy-multi-dc-cluster.md).
...
In addition to it, if you want to use tuning from the Enterprise repository, you have to adjust [**scyllaUtilsImage** on the global ScyllaOperatorConfig/cluster](../../reference/scyllaoperatorconfig-options.md#tuning-with-scylladb-enterprise).
...
For detailed configuration, troubleshooting, and examples, see the [IPv6 networking documentation](../../operations/networking/ipv6-configure.md).
