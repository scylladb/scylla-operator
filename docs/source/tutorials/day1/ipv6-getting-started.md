...
You can view the complete example configuration in the repository: [scylla-cluster-minimal-dual-stack.yaml](https://github.com/scylladb/scylla-operator/blob/master/examples/ipv6/scylla-cluster-minimal-dual-stack.yaml)
...
For more details on how ScyllaDB nodes advertise themselves, see [Exposing ScyllaDB clusters](../../operations/networking/expose-clusters.md).

## What's next?

Now that you have a working IPv6-enabled cluster, you can:

- Learn how to [configure different IPv6 setups](../../operations/networking/ipv6-configure.md) (IPv6-only, different dual-stack configurations)
...
- Learn how to [migrate existing clusters to IPv6](../../operations/networking/ipv6-migrate.md)
...
- [How to configure IPv6 networking](../../operations/networking/ipv6-configure.md)
