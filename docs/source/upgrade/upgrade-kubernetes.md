...
Follow the full procedure in [Migrate a rack to a new node pool](../operate/migrate-rack-to-new-node-pool.md).
...
For a full explanation of how PDBs interact with ScyllaDB pods, see [Pod disruption budgets](../understand/pod-disruption-budgets.md).
