...
- [Connect via CQL](https://operator.docs.scylladb.com/master/connect-your-app/connect-via-cql.md) — CQL connection and authentication setup.
- [Discovery endpoint](https://operator.docs.scylladb.com/master/connect-your-app/discovery.md) — how the client Service works.
