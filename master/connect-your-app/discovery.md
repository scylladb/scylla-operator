...
- [Connect via CQL](https://operator.docs.scylladb.com/master/connect-your-app/connect-via-cql.md) — using the discovery endpoint for CQL connections.
- [Configure external access](https://operator.docs.scylladb.com/master/deploy-scylladb/set-up-networking/configure-external-access.md) — configuring expose options for external connectivity.
