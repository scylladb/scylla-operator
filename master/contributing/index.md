...
3. Attach a [debugging information archive](https://operator.docs.scylladb.com/master/troubleshoot/collect-debugging-information/index.md) if the issue is a runtime problem.
