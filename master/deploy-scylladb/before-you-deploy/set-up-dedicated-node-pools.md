...
See the [GKE cluster setup guide](https://operator.docs.scylladb.com/master/install-operator/provision-infrastructure/set-up-gke-cluster.md) for a complete example.
...
See the [EKS cluster setup guide](https://operator.docs.scylladb.com/master/install-operator/provision-infrastructure/set-up-eks-cluster.md) for a complete example.
...
See the [OKE cluster setup guide](https://operator.docs.scylladb.com/master/install-operator/provision-infrastructure/set-up-oke-cluster.md) for a complete example.
...
The [reference deployments](https://operator.docs.scylladb.com/master/deploy-scylladb/reference-deployments/index.md) include both.
...
For end-to-end node pool creation on a specific platform, see the [platform-specific cluster setup guides](https://operator.docs.scylladb.com/master/install-operator/provision-infrastructure/index.md).
