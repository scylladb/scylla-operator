...
Alternatively, use `UserManaged` certificates from your own PKI or cert-manager for Alternator. See [Alternator](https://operator.docs.scylladb.com/master/connect-your-app/alternator.md) for details.
...
- [Discovery endpoint](https://operator.docs.scylladb.com/master/connect-your-app/discovery.md) — exposing the discovery Service.
- [Connect via CQL](https://operator.docs.scylladb.com/master/connect-your-app/connect-via-cql.md) — client connection setup.
- [Networking architecture](https://operator.docs.scylladb.com/master/understand/networking.md) — how Services and expose options work.
