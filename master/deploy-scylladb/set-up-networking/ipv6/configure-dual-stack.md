...
kubectl apply -f=https://raw.githubusercontent.com/scylladb/scylla-operator/master/examples/ipv6/scylla-cluster-dual-stack.yaml
```
...
- [Migrate existing clusters to IPv6](https://operator.docs.scylladb.com/master/deploy-scylladb/set-up-networking/ipv6/migration.md)
