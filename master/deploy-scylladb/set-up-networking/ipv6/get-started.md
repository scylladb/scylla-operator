...
#### NOTE
This tutorial uses **dual-stack** configuration (both IPv4 and IPv6) because it’s production-ready and well-tested. IPv6-only configurations are experimental. See [Production readiness](https://operator.docs.scylladb.com/master/reference/ipv6-configuration.md#production-readiness) for details.
...
```shell
kubectl apply -f=https://raw.githubusercontent.com/scylladb/scylla-operator/master/examples/ipv6/scylla-cluster-minimal-dual-stack.yaml
```

You can view the complete example configuration in the repository: [scylla-cluster-minimal-dual-stack.yaml](https://operator.docs.scylladb.com/master/../../examples/ipv6/scylla-cluster-minimal-dual-stack.yaml)
...
- Learn how to [configure different IPv6 setups](https://operator.docs.scylladb.com/master/deploy-scylladb/set-up-networking/ipv6/configure-dual-stack.md) (IPv6-only, different dual-stack configurations)
- Understand [how IPv6 networking works](https://operator.docs.scylladb.com/master/deploy-scylladb/set-up-networking/ipv6/ipv6-concepts.md) in ScyllaDB
- Explore the [IPv6 configuration reference](https://operator.docs.scylladb.com/master/reference/ipv6-configuration.md) for all available options
- Learn how to [migrate existing clusters to IPv6](https://operator.docs.scylladb.com/master/deploy-scylladb/set-up-networking/ipv6/migration.md)
