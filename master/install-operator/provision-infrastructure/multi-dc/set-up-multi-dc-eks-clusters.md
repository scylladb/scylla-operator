...
Refer to [Creating an EKS cluster](https://operator.docs.scylladb.com/master/install-operator/provision-infrastructure/set-up-eks-cluster.md#create-the-eksctl-cluster-configuration) section of ScyllaDB Operator documentation for the reference of the configuration of node groups.
