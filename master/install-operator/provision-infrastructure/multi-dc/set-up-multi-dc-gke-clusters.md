...
The interconnected clusters can serve as a platform for [deploying a Multi Datacenter ScyllaDB cluster](https://operator.docs.scylladb.com/master/deploy-scylladb/deploy-multi-datacenter-cluster.md).
...
Refer to [Creating a GKE cluster](https://operator.docs.scylladb.com/master/install-operator/provision-infrastructure/set-up-gke-cluster.md#create-the-dedicated-scylladb-node-pool) section of ScyllaDB Operator documentation for more information regarding the configuration and deployment of additional node pools, including the one dedicated for ScyllaDB nodes.
...
To deploy ScyllaDB Operator follow the [installation guide](https://operator.docs.scylladb.com/master/install-operator/index.md).
...
Refer to [Deploy a multi-datacenter ScyllaDB cluster in multiple interconnected Kubernetes clusters](https://operator.docs.scylladb.com/master/deploy-scylladb/deploy-multi-datacenter-cluster.md) in ScyllaDB Operator documentation for guidance.
