...
- Follow the [Reference deployment: GKE](https://operator.docs.scylladb.com/master/deploy-scylladb/reference-deployments/reference-deployment-gke.md) for a complete ScyllaDB deployment on this cluster.
