...
The `ScyllaCluster` manifest in the [reference deployment](https://operator.docs.scylladb.com/master/deploy-scylladb/reference-deployments/reference-deployment-oke.md) uses one rack per fault domain.
...
- Follow the [Reference deployment: OKE](https://operator.docs.scylladb.com/master/deploy-scylladb/reference-deployments/reference-deployment-oke.md) for a complete ScyllaDB deployment on this cluster.
