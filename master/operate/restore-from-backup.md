...
Restore from backup taken using [ScyllaDB Manager](https://operator.docs.scylladb.com/master/understand/manager.md) to a fresh **empty** cluster of any size.
...
- [Back up and restore](https://operator.docs.scylladb.com/master/operate/back-up-and-restore.md) — overview of backup and restore with ScyllaDB Manager.
- [ScyllaDB Manager](https://operator.docs.scylladb.com/master/understand/manager.md) — how Manager integrates with the Operator.
