...
| `BootstrapSynchronisation` | `true`    | v1.22          |
...
See [Security — ScyllaDB cluster TLS](https://operator.docs.scylladb.com/master/understand/security.md) for the full certificate architecture, and [Connect via CQL](https://operator.docs.scylladb.com/master/connect-your-app/connect-via-cql.md) for client configuration.
...
See [Bootstrap synchronisation](https://operator.docs.scylladb.com/master/understand/bootstrap-sync.md) for details on the mechanism.
