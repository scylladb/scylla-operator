...
See [Passing ScyllaDB arguments](https://operator.docs.scylladb.com/master/operate/pass-scylladb-arguments.md) for details.
...
- In a stuck rollout scenario, ScyllaDB Operator cannot process spec changes because the rollout is blocked.
  ...
  See [StatefulSets and racks](https://operator.docs.scylladb.com/master/understand/statefulsets-and-racks.md) for why a stuck rollout blocks further updates (partition-based rolling updates).

## Related pages

- [Passing ScyllaDB arguments](https://operator.docs.scylladb.com/master/operate/pass-scylladb-arguments.md)
