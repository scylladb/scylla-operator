...
- See [Set up dedicated node pools](https://operator.docs.scylladb.com/master/deploy-scylladb/before-you-deploy/set-up-dedicated-node-pools.md).
...
- [Collecting debugging information](https://operator.docs.scylladb.com/master/troubleshoot/collect-debugging-information/index.md)
