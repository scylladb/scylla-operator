...
For normal node replacement, see [Replace nodes](https://operator.docs.scylladb.com/master/operate/replace-nodes.md).
...
See [Collect debugging information](https://operator.docs.scylladb.com/master/troubleshoot/collect-debugging-information/index.md) for instructions.
...
- [StatefulSets and racks](https://operator.docs.scylladb.com/master/understand/statefulsets-and-racks.md)
- [Collect debugging information](https://operator.docs.scylladb.com/master/troubleshoot/collect-debugging-information/index.md)
