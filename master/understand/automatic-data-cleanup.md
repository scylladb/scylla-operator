...
- [Understand](https://operator.docs.scylladb.com/master/understand/index.md) — component diagram and reconciliation model.
- [Sidecar](https://operator.docs.scylladb.com/master/understand/sidecar.md) — the sidecar that reports node status used for stability checks.
