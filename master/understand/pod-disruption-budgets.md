...
- [Statefulsets and racks](https://operator.docs.scylladb.com/master/understand/statefulsets-and-racks.md) — rolling update strategy and partition-based rollout.
- [Understand](https://operator.docs.scylladb.com/master/understand/index.md) — reconciliation model.
