...
Please refer to [sequential and parallel node operations](https://operator.docs.scylladb.com/master/operate/scale-add-remove-racks.md#sequential-and-parallel-node-operations) for details.
...
See [Scale, add, remove racks](https://operator.docs.scylladb.com/master/operate/scale-add-remove-racks.md) for details.
