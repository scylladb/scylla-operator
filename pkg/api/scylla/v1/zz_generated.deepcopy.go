...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DecommissioningMemberStatus) DeepCopyInto(out *DecommissioningMemberStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DecommissioningMemberStatus.
func (in *DecommissioningMemberStatus) DeepCopy() *DecommissioningMemberStatus {
	if in == nil {
		return nil
	}
	out := new(DecommissioningMemberStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RackStatus) DeepCopyInto(out *RackStatus) {
	*out = *in
	...
	if in.DecommissioningMembers != nil {
		in, out := &in.DecommissioningMembers, &out.DecommissioningMembers
		*out = make([]DecommissioningMemberStatus, len(*in))
		copy(*out, *in)
	}
	if in.Stale != nil {
