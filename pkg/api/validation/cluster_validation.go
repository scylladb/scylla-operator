...
func ValidateScyllaCluster(c *scyllav1.ScyllaCluster) error {
	...
	if c.Spec.GenericUpgrade != nil {
		if c.Spec.GenericUpgrade.FailureStrategy != scyllav1.GenericUpgradeFailureStrategyRetry {
			return errors.Errorf("unsupported generic upgrade failure strategy %q", scyllav1.GenericUpgradeFailureStrategyRetry)
		}
	}
...
func ValidateScyllaClusterUpdate(new, old *scyllav1.ScyllaCluster) error {
	err := ValidateScyllaCluster(new)
	if err != nil {
		return err
	}
