...
func (c *FakeScyllaV1alpha1) ScyllaDBDatacenterStatusReports(namespace string) v1alpha1.ScyllaDBDatacenterStatusReportInterface {
	return newFakeScyllaDBDatacenterStatusReports(c, namespace)
}
