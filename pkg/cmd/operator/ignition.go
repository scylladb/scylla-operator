...
func (o *IgnitionOptions) Execute(ctx context.Context, originalStreams genericclioptions.IOStreams, cmd *cobra.Command) error {
	...
	go func() {
		...
		err := o.ServeProbesOptions.Execute(taskCtx, originalStreams, cmd)
		if err != nil {
