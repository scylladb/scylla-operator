...
func NewScyllaDBAPIStatusOptions(streams genericclioptions.IOStreams) *ScyllaDBAPIStatusOptions {
	...
	return &ScyllaDBAPIStatusOptions{
		ProbeServerOptions: *NewProbeServerOptions(streams, naming.ScyllaDBAPIStatusProbePort, mux),
...
func (o *ScyllaDBAPIStatusOptions) RunCtx(ctx context.Context, originalStreams genericclioptions.IOStreams, cmd *cobra.Command) (returnErr error) {
	...
	return o.ProbeServerOptions.RunCtx(ctx, originalStreams, cmd)
}
