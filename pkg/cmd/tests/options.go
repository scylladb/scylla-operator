...
type TestFrameworkOptions struct {
	genericclioptions.MultiClusterClientConfig
...
func NewTestFrameworkOptions(streams genericclioptions.IOStreams, userAgent string) *TestFrameworkOptions {
	return &TestFrameworkOptions{
		MultiClusterClientConfig: genericclioptions.NewMultiClusterClientConfig(userAgent),
		ArtifactsDir:             "",
...
func (o *TestFrameworkOptions) AddFlags(cmd *cobra.Command) {
	o.MultiClusterClientConfig.AddFlags(cmd)
...
func (o *TestFrameworkOptions) Validate(args []string) error {
	...
	err := o.MultiClusterClientConfig.Validate()
	if err != nil {
...
func (o *TestFrameworkOptions) Complete(args []string) error {
	err := o.MultiClusterClientConfig.Complete()
	if err != nil {
		return err
	}
	...
	workerRestConfigs := make(map[string]*rest.Config, len(o.MultiClusterClientConfig.WorkerClientConfigs))
	for k, v := range o.MultiClusterClientConfig.WorkerClientConfigs {
