...
func (gsmc *Controller) addScyllaDBManagerClusterRegistration(obj interface{}) {
	...
	if !isManagedByGlobalScyllaDBManager(smcr) {
...
func (gsmc *Controller) updateScyllaDBManagerClusterRegistration(old, cur interface{}) {
	...
	if !isManagedByGlobalScyllaDBManager(currentSMCR) {
...
func isManagedByGlobalScyllaDBManager(obj metav1.Object) bool {
	return globalScyllaDBManagerSelector.Matches(labels.Set(obj.GetLabels()))
}
