...
func syncTasks(clusterID string, datacenter *scyllav1.ScyllaCluster, state *state) ([]action, error) {
...
func syncRepairTasks(clusterID string, datacenter *scyllav1.ScyllaCluster, syncer stateCache, managerState *state) ([]action, error) {
	var actions []action
