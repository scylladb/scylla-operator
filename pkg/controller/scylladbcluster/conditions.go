...
var (
	...
	makeRemoteScyllaDBStatusReportControllerDatacenterProgressingCondition = MakeRemoteKindControllerDatacenterConditionFunc("ScyllaDBStatusReport", scyllav1alpha1.ProgressingCondition)
	makeRemoteScyllaDBStatusReportControllerDatacenterDegradedCondition    = MakeRemoteKindControllerDatacenterConditionFunc("ScyllaDBStatusReport", scyllav1alpha1.DegradedCondition)
