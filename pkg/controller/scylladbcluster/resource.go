...
func MakeRemoteRemoteOwners(sc *scyllav1alpha1.ScyllaDBCluster, dc *scyllav1alpha1.ScyllaDBClusterDatacenter, remoteNamespace *corev1.Namespace, managingClusterDomain string) ([]metav1.Condition, []*scyllav1alpha1.RemoteOwner, error) {
...
func MakeRemoteServices(sc *scyllav1alpha1.ScyllaDBCluster, dc *scyllav1alpha1.ScyllaDBClusterDatacenter, remoteNamespace *corev1.Namespace, remoteController metav1.Object, managingClusterDomain string) ([]metav1.Condition, []*corev1.Service) {
	var progressingConditions []metav1.Condition
