...
func (scc *Controller) syncRemoteServices(
	...
	for _, svc := range requiredServices {
		...
		if changed {
			controllerhelpers.AddGenericProgressingStatusCondition(&progressingConditions, fmt.Sprintf(remoteServiceControllerDatacenterProgressingConditionFormat, dc.Name), svc, "apply", sc.Generation)
		}
		if err != nil {
