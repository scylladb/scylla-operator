...
func (sdcc *Controller) syncScyllaDBDatacenterNodesStatusReports(
	...
	err = controllerhelpers.Prune(
		...
		&controllerhelpers.PruneControlFuncs{
			DeleteFunc: ctrlclient.DeleteFunc[scyllav1alpha1.ScyllaDBDatacenterNodesStatusReport](sdcc.client.Client(), sdc.Namespace),
		},
		sdcc.eventRecorder,
	)
	if err != nil {
	...
	_, changed, err := resourceapply.ApplyScyllaDBDatacenterNodesStatusReportWithControl(ctx, ctrlclient.ApplyControl[scyllav1alpha1.ScyllaDBDatacenterNodesStatusReport](ctx, sdcc.client.Client(), sdc.Namespace), sdcc.eventRecorder, scyllaDBDatacenterNodesStatusReport, resourceapply.ApplyOptions{})
	if changed {
