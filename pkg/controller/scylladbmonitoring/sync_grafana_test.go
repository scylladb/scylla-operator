			...
			expectedConfigMaps: []*corev1.ConfigMap{
				{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-manager-3-1",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "manager-3.1",
						},
					},
					Data: map[string]string{
						"scylla-manager.3.1.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-manager-3-2",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "manager-3.2",
						},
					},
					Data: map[string]string{
						"scylla-manager.3.2.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-2022-1",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-2022.1",
						},
					},
					Data: map[string]string{
						"alternator.2022.1.json.gz.base64":      "<non_empty>",
						"scylla-advanced.2022.1.json.gz.base64": "<non_empty>",
						"scylla-cql.2022.1.json.gz.base64":      "<non_empty>",
						"scylla-detailed.2022.1.json.gz.base64": "<non_empty>",
						"scylla-ks.2022.1.json.gz.base64":       "<non_empty>",
						"scylla-os.2022.1.json.gz.base64":       "<non_empty>",
						"scylla-overview.2022.1.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-2022-2",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-2022.2",
						},
					},
					Data: map[string]string{
						"alternator.2022.2.json.gz.base64":      "<non_empty>",
						"scylla-advanced.2022.2.json.gz.base64": "<non_empty>",
						"scylla-cql.2022.2.json.gz.base64":      "<non_empty>",
						"scylla-detailed.2022.2.json.gz.base64": "<non_empty>",
						"scylla-ks.2022.2.json.gz.base64":       "<non_empty>",
						"scylla-os.2022.2.json.gz.base64":       "<non_empty>",
						"scylla-overview.2022.2.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-2023-1",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-2023.1",
						},
					},
					Data: map[string]string{
						"alternator.2023.1.json.gz.base64":      "<non_empty>",
						"scylla-advanced.2023.1.json.gz.base64": "<non_empty>",
						"scylla-cql.2023.1.json.gz.base64":      "<non_empty>",
						"scylla-detailed.2023.1.json.gz.base64": "<non_empty>",
						"scylla-ks.2023.1.json.gz.base64":       "<non_empty>",
						"scylla-os.2023.1.json.gz.base64":       "<non_empty>",
						"scylla-overview.2023.1.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-2024-1",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-2024.1",
						},
					},
					Data: map[string]string{
						"alternator.2024.1.json.gz.base64":      "<non_empty>",
						"scylla-advanced.2024.1.json.gz.base64": "<non_empty>",
						"scylla-cql.2024.1.json.gz.base64":      "<non_empty>",
						"scylla-detailed.2024.1.json.gz.base64": "<non_empty>",
						"scylla-ks.2024.1.json.gz.base64":       "<non_empty>",
						"scylla-os.2024.1.json.gz.base64":       "<non_empty>",
						"scylla-overview.2024.1.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-5-2",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-5.2",
						},
					},
					Data: map[string]string{
						"alternator.5.2.json.gz.base64":      "<non_empty>",
						"scylla-advanced.5.2.json.gz.base64": "<non_empty>",
						"scylla-cql.5.2.json.gz.base64":      "<non_empty>",
						"scylla-detailed.5.2.json.gz.base64": "<non_empty>",
						"scylla-ks.5.2.json.gz.base64":       "<non_empty>",
						"scylla-os.5.2.json.gz.base64":       "<non_empty>",
						"scylla-overview.5.2.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-5-3",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-5.3",
						},
					},
					Data: map[string]string{
						"alternator.5.3.json.gz.base64":      "<non_empty>",
						"scylla-advanced.5.3.json.gz.base64": "<non_empty>",
						"scylla-cql.5.3.json.gz.base64":      "<non_empty>",
						"scylla-detailed.5.3.json.gz.base64": "<non_empty>",
						"scylla-ks.5.3.json.gz.base64":       "<non_empty>",
						"scylla-os.5.3.json.gz.base64":       "<non_empty>",
						"scylla-overview.5.3.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-5-4",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-5.4",
						},
					},
					Data: map[string]string{
						"alternator.5.4.json.gz.base64":      "<non_empty>",
						"scylla-advanced.5.4.json.gz.base64": "<non_empty>",
						"scylla-cql.5.4.json.gz.base64":      "<non_empty>",
						"scylla-detailed.5.4.json.gz.base64": "<non_empty>",
						"scylla-ks.5.4.json.gz.base64":       "<non_empty>",
						"scylla-os.5.4.json.gz.base64":       "<non_empty>",
						"scylla-overview.5.4.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					Data: map[string]string{
						"alternator.6.0.json.gz.base64":      "<non_empty>",
						"scylla-advanced.6.0.json.gz.base64": "<non_empty>",
						"scylla-cql.6.0.json.gz.base64":      "<non_empty>",
						"scylla-detailed.6.0.json.gz.base64": "<non_empty>",
						"scylla-ks.6.0.json.gz.base64":       "<non_empty>",
						"scylla-os.6.0.json.gz.base64":       "<non_empty>",
						"scylla-overview.6.0.json.gz.base64": "<non_empty>",
					},
				},
				{
					TypeMeta: metav1.TypeMeta{
					...
					ObjectMeta: metav1.ObjectMeta{
						Name: "sm-name-grafana-scylladb-dashboards-scylladb-master",
						Annotations: map[string]string{
							"internal.scylla-operator.scylladb.com/dashboard-name": "scylladb-master",
						},
					},
					Data: map[string]string{
						"alternator.master.json.gz.base64":      "<non_empty>",
						"scylla-advanced.master.json.gz.base64": "<non_empty>",
						"scylla-cql.master.json.gz.base64":      "<non_empty>",
						"scylla-detailed.master.json.gz.base64": "<non_empty>",
						"scylla-ks.master.json.gz.base64":       "<non_empty>",
						"scylla-os.master.json.gz.base64":       "<non_empty>",
						"scylla-overview.master.json.gz.base64": "<non_empty>",
					},
				},
			},
			expectedErr: nil,
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			if err == nil {
				for _, cm := range cms {
					...
					validationErr := utilerrors.NewAggregate(slices.ConvertSlice[error](errMessages, func(s string) error {
						return errors.New(s)
					}))
...
`, "\n"),
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(err, tc.expectedErr) {
				t.Fatalf("expected and got errors differ:\n%s\nRendered object:\n%s", cmp.Diff(tc.expectedErr, err), deploymentString)
			}
