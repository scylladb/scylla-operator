...
func (smc *Controller) syncPrometheus(
	...
	// Render manifests.
	requiredResources, err := prepareRequiredPrometheusResources(sm, soc)
	if err != nil {
...
func prepareRequiredPrometheusResources(sm *scyllav1alpha1.ScyllaDBMonitoring, soc *scyllav1alpha1.ScyllaOperatorConfig) (requiredPrometheusResources, error) {
	var renderErrors []error
	var resources requiredPrometheusResources

	var err error
	if prometheusMode(sm) == scyllav1alpha1.PrometheusModeManaged {
