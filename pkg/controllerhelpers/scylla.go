...
func GetScyllaHost(sdc *scyllav1alpha1.ScyllaDBDatacenter, svc *corev1.Service, pod *corev1.Pod) (string, error) {
	...
	return GetScyllaBroadcastAddress(nodeBroadcastAddressType, svc, pod, nil)
}
...
func GetScyllaClientBroadcastHost(sdc *scyllav1alpha1.ScyllaDBDatacenter, svc *corev1.Service, pod *corev1.Pod) (string, error) {
	...
	return GetScyllaBroadcastAddress(clientsBroadcastAddressType, svc, pod, nil)
}
...
func GetScyllaHostForScyllaCluster(sc *scyllav1.ScyllaCluster, svc *corev1.Service, pod *corev1.Pod) (string, error) {
	...
	return GetScyllaBroadcastAddress(scyllav1alpha1.BroadcastAddressType(nodeBroadcastAddressType), svc, pod, nil)
}

func GetScyllaBroadcastAddress(broadcastAddressType scyllav1alpha1.BroadcastAddressType, svc *corev1.Service, pod *corev1.Pod, preferredIPFamily *corev1.IPFamily) (string, error) {
	...
	case scyllav1alpha1.BroadcastAddressTypeServiceLoadBalancerIngress:
		...
		if preferredIPFamily != nil {
			preferredFamily := *preferredIPFamily
