...
func New(options Options) (*Manager, error) {
	...
	mgr, err := ctrlmanager.New(options.RestConfig, ctrlmanager.Options{
		...
		// the informer to catch up. Don't copy this into a binary with a narrowly filtered cache: there a read of an
		// object the informer never observes blocks until the context deadline.
