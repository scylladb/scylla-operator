...
func TestX509CertCreator_MakeCertificate(t *testing.T) {
	...
	tt := []struct {
	...
	}{
		{
			...
			keyGeneratorCfg: KeyGeneratorConfig{Type: RSAKeyType, KeySize: 4096, BufferSizeMin: 1, BufferSizeMax: 1, BufferDelay: defaultTestBufferDelay},
			signer:          ca,
		...
		},
		{
			...
			keyGeneratorCfg: KeyGeneratorConfig{Type: ECDSAKeyType, KeySize: 256, BufferSizeMin: 1, BufferSizeMax: 1, BufferDelay: defaultTestBufferDelay},
		...
		},
		{
			...
			keyGeneratorCfg: KeyGeneratorConfig{Type: ECDSAKeyType, KeySize: 384, BufferSizeMin: 1, BufferSizeMax: 1, BufferDelay: defaultTestBufferDelay},
			signer:          selfSignedSigner,
			lifetime:        1 * time.Hour,
			verifyCert: func(t *testing.T, cert *x509.Certificate) {
		...
		},
		{
			...
			keyGeneratorCfg: KeyGeneratorConfig{Type: ECDSAKeyType, KeySize: 521, BufferSizeMin: 1, BufferSizeMax: 1, BufferDelay: defaultTestBufferDelay},
			signer:          selfSignedSigner,
