...
func NewPodLister(ctx context.Context, c client.Client) corev1listers.PodLister {
...
func NewSecretLister(ctx context.Context, c client.Client) corev1listers.SecretLister {
