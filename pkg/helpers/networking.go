...
func GetPreferredServiceIP(svc *corev1.Service, preferredFamily *corev1.IPFamily) (string, bool) {
	if svc == nil {
		return "", false
	}
	...
	selectedIP, _ := GetPreferredIP(validIPs, preferredFamily)
	return selectedIP, true
}
...
func IPFamilyToAddressType(ipFamily corev1.IPFamily) discoveryv1.AddressType {
