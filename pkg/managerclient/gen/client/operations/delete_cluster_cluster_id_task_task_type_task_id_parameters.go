...
DeleteClusterClusterIDTaskTaskTypeTaskIDParams contains all the parameters to send to the API endpoint
	...
	for the delete cluster cluster ID task task type task ID operation.
...
// WithDefaults hydrates default values in the delete cluster cluster ID task task type task ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteClusterClusterIDTaskTaskTypeTaskIDParams) WithDefaults() *DeleteClusterClusterIDTaskTaskTypeTaskIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete cluster cluster ID task task type task ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteClusterClusterIDTaskTaskTypeTaskIDParams) SetDefaults() {
