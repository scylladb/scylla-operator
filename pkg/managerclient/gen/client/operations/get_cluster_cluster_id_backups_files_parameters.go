...
GetClusterClusterIDBackupsFilesParams contains all the parameters to send to the API endpoint
	...
	for the get cluster cluster ID backups files operation.
...
// WithDefaults hydrates default values in the get cluster cluster ID backups files params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDBackupsFilesParams) WithDefaults() *GetClusterClusterIDBackupsFilesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cluster cluster ID backups files params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDBackupsFilesParams) SetDefaults() {
...
// WithQueryClusterID adds the queryClusterID to the get cluster cluster ID backups files params
func (o *GetClusterClusterIDBackupsFilesParams) WithQueryClusterID(queryClusterID *string) *GetClusterClusterIDBackupsFilesParams {
	o.SetQueryClusterID(queryClusterID)
	return o
}

// SetQueryClusterID adds the queryClusterId to the get cluster cluster ID backups files params
func (o *GetClusterClusterIDBackupsFilesParams) SetQueryClusterID(queryClusterID *string) {
...
func (o *GetClusterClusterIDBackupsFilesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Keyspace != nil {
		...
		// binding items for keyspace
		joinedKeyspace := o.bindParamKeyspace(reg)
...
// bindParamGetClusterClusterIDBackupsFiles binds the parameter keyspace
func (o *GetClusterClusterIDBackupsFilesParams) bindParamKeyspace(formats strfmt.Registry) []string {
	keyspaceIR := o.Keyspace

	var keyspaceIC []string
	for _, keyspaceIIR := range keyspaceIR { // explode []string

		keyspaceIIV := keyspaceIIR // string as string
		keyspaceIC = append(keyspaceIC, keyspaceIIV)
	}

	// items.CollectionFormat: ""
	keyspaceIS := swag.JoinByFormat(keyspaceIC, "")

	return keyspaceIS
}

// bindParamGetClusterClusterIDBackupsFiles binds the parameter locations
func (o *GetClusterClusterIDBackupsFilesParams) bindParamLocations(formats strfmt.Registry) []string {
