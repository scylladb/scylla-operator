...
GetClusterClusterIDBackupsParams contains all the parameters to send to the API endpoint
	...
	for the get cluster cluster ID backups operation.
...
// WithDefaults hydrates default values in the get cluster cluster ID backups params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDBackupsParams) WithDefaults() *GetClusterClusterIDBackupsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cluster cluster ID backups params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDBackupsParams) SetDefaults() {
...
// WithQueryClusterID adds the queryClusterID to the get cluster cluster ID backups params
func (o *GetClusterClusterIDBackupsParams) WithQueryClusterID(queryClusterID *string) *GetClusterClusterIDBackupsParams {
	o.SetQueryClusterID(queryClusterID)
	return o
}

// SetQueryClusterID adds the queryClusterId to the get cluster cluster ID backups params
func (o *GetClusterClusterIDBackupsParams) SetQueryClusterID(queryClusterID *string) {
...
// bindParamGetClusterClusterIDBackups binds the parameter keyspace
func (o *GetClusterClusterIDBackupsParams) bindParamKeyspace(formats strfmt.Registry) []string {
...
// bindParamGetClusterClusterIDBackups binds the parameter locations
func (o *GetClusterClusterIDBackupsParams) bindParamLocations(formats strfmt.Registry) []string {
