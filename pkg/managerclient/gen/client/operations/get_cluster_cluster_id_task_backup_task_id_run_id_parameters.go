...
GetClusterClusterIDTaskBackupTaskIDRunIDParams contains all the parameters to send to the API endpoint
	...
	for the get cluster cluster ID task backup task ID run ID operation.
...
// WithDefaults hydrates default values in the get cluster cluster ID task backup task ID run ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDTaskBackupTaskIDRunIDParams) WithDefaults() *GetClusterClusterIDTaskBackupTaskIDRunIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cluster cluster ID task backup task ID run ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDTaskBackupTaskIDRunIDParams) SetDefaults() {
