...
GetClusterClusterIDTaskRepairTaskIDRunIDParams contains all the parameters to send to the API endpoint
	...
	for the get cluster cluster ID task repair task ID run ID operation.
...
// WithDefaults hydrates default values in the get cluster cluster ID task repair task ID run ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDTaskRepairTaskIDRunIDParams) WithDefaults() *GetClusterClusterIDTaskRepairTaskIDRunIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cluster cluster ID task repair task ID run ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDTaskRepairTaskIDRunIDParams) SetDefaults() {
