...
GetClusterClusterIDTaskTaskTypeTaskIDHistoryParams contains all the parameters to send to the API endpoint
	...
	for the get cluster cluster ID task task type task ID history operation.
...
// WithDefaults hydrates default values in the get cluster cluster ID task task type task ID history params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDTaskTaskTypeTaskIDHistoryParams) WithDefaults() *GetClusterClusterIDTaskTaskTypeTaskIDHistoryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cluster cluster ID task task type task ID history params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetClusterClusterIDTaskTaskTypeTaskIDHistoryParams) SetDefaults() {
