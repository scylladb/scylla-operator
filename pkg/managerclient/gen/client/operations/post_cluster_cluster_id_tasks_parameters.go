...
PostClusterClusterIDTasksParams contains all the parameters to send to the API endpoint
	...
	for the post cluster cluster ID tasks operation.
...
// WithDefaults hydrates default values in the post cluster cluster ID tasks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostClusterClusterIDTasksParams) WithDefaults() *PostClusterClusterIDTasksParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post cluster cluster ID tasks params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostClusterClusterIDTasksParams) SetDefaults() {
