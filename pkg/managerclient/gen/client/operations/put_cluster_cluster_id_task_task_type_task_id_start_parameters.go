...
PutClusterClusterIDTaskTaskTypeTaskIDStartParams contains all the parameters to send to the API endpoint
	...
	for the put cluster cluster ID task task type task ID start operation.
...
// WithDefaults hydrates default values in the put cluster cluster ID task task type task ID start params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutClusterClusterIDTaskTaskTypeTaskIDStartParams) WithDefaults() *PutClusterClusterIDTaskTaskTypeTaskIDStartParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put cluster cluster ID task task type task ID start params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutClusterClusterIDTaskTaskTypeTaskIDStartParams) SetDefaults() {
