...
PutClusterClusterIDTaskTaskTypeTaskIDStopParams contains all the parameters to send to the API endpoint
	...
	for the put cluster cluster ID task task type task ID stop operation.
...
// WithDefaults hydrates default values in the put cluster cluster ID task task type task ID stop params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutClusterClusterIDTaskTaskTypeTaskIDStopParams) WithDefaults() *PutClusterClusterIDTaskTaskTypeTaskIDStopParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put cluster cluster ID task task type task ID stop params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutClusterClusterIDTaskTaskTypeTaskIDStopParams) SetDefaults() {
