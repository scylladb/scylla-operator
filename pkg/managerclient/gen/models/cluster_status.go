...
// ContextValidate validates this cluster status items0 based on context it is used
func (m *ClusterStatusItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
