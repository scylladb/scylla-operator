...
func (m *HostProgress) validateCompletedAt(formats strfmt.Registry) error {
		...
		if m.Keyspaces[i] != nil {
			if err := m.Keyspaces[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("keyspaces" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *HostProgress) validateStartedAt(formats strfmt.Registry) error {
...
func (m *HostProgress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateKeyspaces(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *HostProgress) contextValidateKeyspaces(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.Keyspaces); i++ {

		if m.Keyspaces[i] != nil {
			if err := m.Keyspaces[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("keyspaces" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("keyspaces" + "." + strconv.Itoa(i))
