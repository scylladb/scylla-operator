...
// ContextValidate validate this repair progress based on the context it is used
func (m *RepairProgress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RepairProgress) contextValidateHosts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RepairProgress) contextValidateTables(ctx context.Context, formats strfmt.Registry) error {
...
// ContextValidate validate this repair progress hosts items0 based on the context it is used
func (m *RepairProgressHostsItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RepairProgressHostsItems0) contextValidateTables(ctx context.Context, formats strfmt.Registry) error {
