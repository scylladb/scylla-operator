...
// ContextValidate validate this task run repair progress based on the context it is used
func (m *TaskRunRepairProgress) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TaskRunRepairProgress) contextValidateProgress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TaskRunRepairProgress) contextValidateRun(ctx context.Context, formats strfmt.Registry) error {
