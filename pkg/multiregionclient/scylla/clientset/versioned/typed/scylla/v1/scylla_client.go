...
import (
	...
	"github.com/scylladb/scylla-operator/pkg/multiregionclient/scylla/clientset/versioned/scheme"
...
// NewForConfig creates a new ScyllaV1Client for the given config.
...
// NewForConfigAndClient creates a new ScyllaV1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ScyllaV1Client, error) {
	...
	return &ScyllaV1Client{client}, nil
}

// NewForConfigOrDie creates a new ScyllaV1Client for the given config and
...
func New(c rest.Interface) *ScyllaV1Client {
	return &ScyllaV1Client{c}
}
