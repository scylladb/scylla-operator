...
type ScyllaClusterRemoteLister interface {
	Datacenter(string) ScyllaClusterLister
}

type scyllaClusterRemoteLister struct {
	makeInformer func(string) cache.SharedIndexInformer
}

func (s *scyllaClusterRemoteLister) Datacenter(datacenter string) ScyllaClusterLister {
	return NewScyllaClusterLister(s.makeInformer(datacenter).GetIndexer())
}

func NewScyllaClusterRemoteLister(f func(string)cache.SharedIndexInformer) *scyllaClusterRemoteLister{
	return &scyllaClusterRemoteLister{makeInformer: f}
}
