...
func (o *CacheServiceMetricsCounterHitsGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewCacheServiceMetricsCounterHitsGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCacheServiceMetricsCounterHitsGetDefault(code int) *CacheServiceMetricsCounterHitsGetDefault {
	return &CacheServiceMetricsCounterHitsGetDefault{
		_statusCode: code,
	}
}
...
func (o *CacheServiceMetricsCounterHitsGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
