...
func (o *StorageServiceStreamThroughputGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewStorageServiceStreamThroughputGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewStorageServiceStreamThroughputGetDefault(code int) *StorageServiceStreamThroughputGetDefault {
	return &StorageServiceStreamThroughputGetDefault{
		_statusCode: code,
	}
}
...
func (o *StorageServiceStreamThroughputGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
