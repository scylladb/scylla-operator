...
| Use case                                                                  | Tool                                                                                                                           |
|---------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| Kubernetes-level diagnostics (pod status, events, logs)                   | [Collect debugging information](https://operator.docs.scylladb.com/stable/troubleshoot/collect-debugging-information/index.md) |
