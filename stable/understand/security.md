...
- **Read** internal node-status report resources — used for [bootstrap synchronisation](https://operator.docs.scylladb.com/stable/understand/bootstrap-sync.md) state.
...
ScyllaDB Manager communicates with ScyllaDB nodes through the [Manager Agent](https://operator.docs.scylladb.com/stable/understand/manager.md), which runs as a sidecar container in each ScyllaDB pod. The Agent exposes a REST API on port 10001.
...
- [Understand](https://operator.docs.scylladb.com/stable/understand/index.md) — reconciliation model and component layout.
- [Manager](https://operator.docs.scylladb.com/stable/understand/manager.md) — ScyllaDB Manager deployment model.
- [Pod disruption budgets](https://operator.docs.scylladb.com/stable/understand/pod-disruption-budgets.md) — how operator and webhook PDBs protect availability.
- [Sidecar](https://operator.docs.scylladb.com/stable/understand/sidecar.md) — containers in a ScyllaDB pod, including the Agent sidecar.
- [Ignition](https://operator.docs.scylladb.com/stable/understand/ignition.md) — startup gating that depends on certificate readiness.
