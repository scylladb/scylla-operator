...
|   3 | `scylladb-ignition`         | Operator      | Evaluates startup prerequisites (tuning done, IPs assigned, container running) and creates the ignition signal file when all are met. See [Ignition](https://operator.docs.scylladb.com/stable/understand/ignition.md). | Always present                              |
