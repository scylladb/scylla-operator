...
Please refer to [sequential and parallel node provisioning](https://operator.docs.scylladb.com/stable/operate/scale-add-remove-racks.md#sequential-and-parallel-node-provisioning) for details.
...
Replacement works on any ordinal because the pod identity and PVC are tied to the ordinal — the StatefulSet recreates a pod with the same name at the same position. See [Replace nodes](https://operator.docs.scylladb.com/stable/operate/replace-nodes.md) for the step-by-step procedure.
...
- [Pod disruption budgets](https://operator.docs.scylladb.com/stable/understand/pod-disruption-budgets.md) — how PDBs interact with rolling updates and scale-down.
- [Sidecar](https://operator.docs.scylladb.com/stable/understand/sidecar.md) — what runs inside each pod and how decommission is driven.
- [Scaling](https://operator.docs.scylladb.com/stable/operate/scale-add-remove-racks.md) — how-to guide for scaling operations.
- [Replacing nodes](https://operator.docs.scylladb.com/stable/operate/replace-nodes.md) — how-to guide for node replacement.
- [Changing log level](https://operator.docs.scylladb.com/stable/troubleshoot/change-log-level.md) — emergency changes when a rollout is stuck.
