...
Please refer to the [ScyllaDB Manager installation instructions](https://operator.docs.scylladb.com/stable/deploy-scylladb/install-scylladb-manager.md) for details.
...
Please refer to the [GitOps installation instructions](https://operator.docs.scylladb.com/stable/install-operator/install-with-gitops.md) for details.
...
- Update ScyllaDB Operator dependencies to the versions compatible with the target ScyllaDB Operator version.
  Refer to the [Helm installation instructions](https://operator.docs.scylladb.com/stable/install-operator/install-with-helm.md) for details.
