...
type ClusterInterface interface {
	...
	AddCleaners(cleaners ...CleanupInterface)
	AddCollectors(collectors ...CollectInterface)
}
...
func (c *Cluster) AddCollectors(collectors ...CollectInterface) {
