...
func NewDataInserter(ctx context.Context, client corev1client.CoreV1Interface, keyspace string, sc *scyllav1.ScyllaCluster, replicationFactor int32) (*DataInserter, error) {
