...
var _ = g.Describe("ScyllaCluster", func() {
	...
	g.It("should claim preexisting member ServiceAccount and RoleBinding", func() {
		...
		framework.By("Waiting for the child ScyllaDatacenter to be created")
		waitCtx1, waitCtx1Cancel := v1utils.ContextForRollout(ctx, sc)
		defer waitCtx1Cancel()
		sd, err := v1alpha1.WaitForScyllaDatacenterState(waitCtx1, f.ScyllaClient().ScyllaV1alpha1(), sc.Namespace, sc.Name, utils.WaitForStateOptions{TolerateDelete: false}, func(datacenter *scyllav1alpha1.ScyllaDatacenter) (bool, error) {
