	...
	o.Expect(sc.Status.Conditions).To(o.ConsistOf(func() []interface{} {
		...
		for _, dc := range sc.Spec.Datacenters {
			dcCondList := []condValue{
				...
				{
					condType: scylladbclustercontroller.MakeRemoteKindControllerDatacenterConditionFunc("ScyllaDBStatusReport", scyllav1alpha1.ProgressingCondition)(dc.Name),
					status:   metav1.ConditionFalse,
				},
				{
					condType: scylladbclustercontroller.MakeRemoteKindControllerDatacenterConditionFunc("ScyllaDBStatusReport", scyllav1alpha1.DegradedCondition)(dc.Name),
					status:   metav1.ConditionFalse,
				},
			}
