...
You can learn more about different setups in [a dedicated storage section](https://operator.docs.scylladb.com/v1.18/architecture/storage/overview.md).
