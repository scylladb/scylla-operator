...
```shell
curl --fail --retry 5 --retry-all-errors -o 'clusterconfig.eksctl.yaml' -L https://raw.githubusercontent.com/scylladb/scylla-operator/v1.18/examples/eks/clusterconfig.eksctl.yaml
```
...
We also hve a whole section dedicated to [how you can access the ScyllaDB cluster you’ve just created](https://operator.docs.scylladb.com/v1.18/resources/scyllaclusters/clients/index.md).
