...
For details of ScyllaDB cluster deployments and their configuration, see the [ScyllaCluster resource documentation](https://operator.docs.scylladb.com/v1.18/resources/scyllaclusters/basics.md).
...
- running Scylla Operator and its prerequisites
...
In v1.11, Scylla Operator introduced support for manual multi-datacenter ScyllaDB cluster deployments.

#### WARNING
Scylla Operator only supports *manual configuration* of multi-datacenter ScyllaDB clusters.
In other words, although ScyllaCluster API exposes the machinery necessary for setting up multi-datacenter ScylaDB clusters, the Scylla Operator only automates operations for a single datacenter.
...
However, other configuration options allow for the manual deployment of multi-datacenter ScyllaDB clusters in different network setups. For details, refer to [Exposing ScyllaClusters](https://operator.docs.scylladb.com/v1.18/resources/common/exposing.md) in Scylla Operator documentation.
...
To deploy Scylla Manager, follow the steps described in [Deploying Scylla Manager on a Kubernetes Cluster](https://operator.docs.scylladb.com/v1.18/architecture/manager.md)
in Scylla Operator documentation.
...
To deploy ScyllaDB Monitoring, follow the steps described in [Deploy managed monitoring](https://operator.docs.scylladb.com/v1.18/resources/scylladbmonitorings.md#deploy-managed-monitoring) in Scylla Operator documentation.
