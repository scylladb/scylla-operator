...
[ScyllaOperatorConfig](https://operator.docs.scylladb.com/v1.18/api-reference/groups/scylla.scylladb.com/scyllaoperatorconfigs.md) holds the global configuration for Scylla Operator.
It is automatically created by Scylla Operator, if it’s missing, and also reports some of the configuration (like auxiliary images) that are in use.
...
```yaml
 spec:
   scyllaUtilsImage: "docker.io/scylladb/scylla-enterprise:2025.1.5"
```
