...
Scylla Operator’s [NodeConfig](https://operator.docs.scylladb.com/v1.19/resources/nodeconfigs.md) controller requires `xfsprogs` to be installed on the Kubernetes
