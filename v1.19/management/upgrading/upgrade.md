...
Note that Scylla Operator’s dependencies also need to be updated to the versions compatible with the target Scylla Operator version.

Please refer to the [GitOps installation instructions](https://operator.docs.scylladb.com/v1.19/installation/gitops.md) for details.

## Upgrade via Helm

### Prerequisites

- Update Scylla Operator dependencies to the versions compatible with the target Scylla Operator version.
  Refer to the [Helm installation instructions](https://operator.docs.scylladb.com/v1.19/installation/helm.md) for details.
