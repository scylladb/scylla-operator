...
First, we need to create a kubelet config to configure [static CPU policy](https://operator.docs.scylladb.com/v1.19/installation/kubernetes-prerequisites.md#static-cpu-policy):
...
This package is required to format the local NVMe disks used by ScyllaDB. Please refer to the [xfsprogs section](https://operator.docs.scylladb.com/v1.19/installation/kubernetes-prerequisites.md#xfsprogs) of the Kubernetes prerequisites page for more details.
...
We also have a whole section dedicated to [how you can access the ScyllaDB cluster you’ve just created](https://operator.docs.scylladb.com/v1.19/resources/scyllaclusters/clients/index.md).
