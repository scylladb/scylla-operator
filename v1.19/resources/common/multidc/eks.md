...
Refer to [Creating an EKS cluster](https://operator.docs.scylladb.com/v1.19/quickstarts/eks.md#creating-an-eks-cluster) section of ScyllaDB Operator documentation for the reference of the configuration of node groups.
...
Refer to [Deploy a multi-datacenter ScyllaDB cluster in multiple interconnected Kubernetes clusters](https://operator.docs.scylladb.com/v1.19/resources/scyllaclusters/multidc/multidc.md) in ScyllaDB Operator documentation for guidance.
