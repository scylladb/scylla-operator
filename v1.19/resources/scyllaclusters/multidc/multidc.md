...
For details of ScyllaDB cluster deployments and their configuration, see the [ScyllaCluster resource documentation](https://operator.docs.scylladb.com/v1.19/resources/scyllaclusters/basics.md).
...
However, other configuration options allow for the manual deployment of multi-datacenter ScyllaDB clusters in different network setups. For details, refer to [Exposing ScyllaClusters](https://operator.docs.scylladb.com/v1.19/resources/common/exposing.md) in Scylla Operator documentation.
...
To deploy Scylla Manager, follow the steps described in [Deploying Scylla Manager on a Kubernetes Cluster](https://operator.docs.scylladb.com/v1.19/architecture/manager.md)
...
To deploy ScyllaDB Monitoring, follow the steps described in [ScyllaDB Monitoring setup](https://operator.docs.scylladb.com/v1.19/management/monitoring/setup.md) in Scylla Operator documentation.
