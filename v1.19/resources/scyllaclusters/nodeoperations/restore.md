...
This procedure will describe how to restore from backup taken using [Scylla Manager](https://operator.docs.scylladb.com/v1.19/architecture/manager.md) to a fresh **empty** cluster of any size.
...
Refer to [API Reference](https://operator.docs.scylladb.com/v1.19/reference/api/index.md) to learn how to customize ScyllaDB configuration files.
