...
When a node is being upgraded, [maintenance mode](https://operator.docs.scylladb.com/v1.19/resources/scyllaclusters/nodeoperations/maintenance-mode.md) is enabled, then the node is drained and snapshot of all data keyspaces is taken.
