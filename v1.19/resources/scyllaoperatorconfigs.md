...
[ScyllaOperatorConfig](https://operator.docs.scylladb.com/v1.19/reference/api/groups/scylla.scylladb.com/scyllaoperatorconfigs.md) holds the global configuration for Scylla Operator.
...
```yaml
 spec:
   scyllaUtilsImage: "docker.io/scylladb/scylla-enterprise:2025.3.3"
```
