...
- [Connect via CQL](https://operator.docs.scylladb.com/v1.21/connect-your-app/connect-via-cql.md) — using the discovery endpoint for CQL connections.
- [Configure external access](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-networking/configure-external-access.md) — configuring expose options for external connectivity.
