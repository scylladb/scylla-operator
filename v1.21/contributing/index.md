...
3. Attach a [debugging information archive](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/index.md) if the issue is a runtime problem.
