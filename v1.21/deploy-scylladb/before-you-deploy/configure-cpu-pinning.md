...
The [OKE cluster setup guide](https://operator.docs.scylladb.com/v1.21/install-operator/provision-infrastructure/set-up-oke-cluster.md) applies this automatically.
...
To verify CPU pinning is active and troubleshoot common issues, see [Troubleshoot performance](https://operator.docs.scylladb.com/v1.21/troubleshoot/troubleshoot-performance.md).
