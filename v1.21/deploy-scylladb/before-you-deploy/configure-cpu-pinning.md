...
The [OKE cluster setup guide](https://operator.docs.scylladb.com/stable/install-operator/provision-infrastructure/set-up-oke-cluster.md) applies this automatically.
...
To verify CPU pinning is active and troubleshoot common issues, see [Troubleshoot performance](https://operator.docs.scylladb.com/stable/troubleshoot/troubleshoot-performance.md).
