...
- [Build multiple Amazon EKS clusters with Inter-Kubernetes networking](https://operator.docs.scylladb.com/v1.21/install-operator/provision-infrastructure/multi-dc/set-up-multi-dc-eks-clusters.md)
- [Build multiple GKE clusters with Inter-Kubernetes networking](https://operator.docs.scylladb.com/v1.21/install-operator/provision-infrastructure/multi-dc/set-up-multi-dc-gke-clusters.md)
...
To deploy ScyllaDB Manager, follow the steps described in [Deploying ScyllaDB Manager on a Kubernetes Cluster](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/install-scylladb-manager.md)
...
To deploy ScyllaDB Monitoring, follow the steps described in [ScyllaDB Monitoring setup](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-monitoring/setup.md) in ScyllaDB Operator documentation.
