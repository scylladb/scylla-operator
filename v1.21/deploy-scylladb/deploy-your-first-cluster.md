...
For production-grade deployments with multi-rack, multi-zone configurations and properly sized resources, follow a [reference deployment](https://operator.docs.scylladb.com/stable/deploy-scylladb/reference-deployments/index.md) for your platform.

## Key fields explained

For the full API reference, see the [API reference](https://operator.docs.scylladb.com/stable/reference/api/index.md).
