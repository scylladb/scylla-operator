...
[`ScyllaDBMonitoring`](https://operator.docs.scylladb.com/v1.21/reference/api/groups/scylla.scylladb.com/scylladbmonitorings.md) custom resource and an external `Prometheus` instance.

The guide assumes you have read the [overview](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-monitoring/index.md) of ScyllaDB monitoring and are familiar with the concepts of Prometheus and Grafana.
...
see the [`ScyllaDBMonitoring` API reference](https://operator.docs.scylladb.com/v1.21/reference/api/groups/scylla.scylladb.com/scylladbmonitorings.md).
...
- **Prometheus Operator** - must be installed **before** ScyllaDB Operator. ScyllaDB Operator detects Prometheus Operator CRDs
  ...
  ```
- **ScyllaDB Operator** - for more information on how to deploy it, see [the installation guide](https://operator.docs.scylladb.com/v1.21/install-operator/index.md).
...
To learn how to access Grafana, see the [Expose Grafana](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-monitoring/exposing-grafana.md) guide.
