...
Alternatively, use `UserManaged` certificates from your own PKI or cert-manager for Alternator. See [Alternator](https://operator.docs.scylladb.com/v1.21/connect-your-app/alternator.md) for details.
...
- [Discovery endpoint](https://operator.docs.scylladb.com/v1.21/connect-your-app/discovery.md) — exposing the discovery Service.
- [Connect via CQL](https://operator.docs.scylladb.com/v1.21/connect-your-app/connect-via-cql.md) — client connection setup.
- [Networking architecture](https://operator.docs.scylladb.com/v1.21/understand/networking.md) — how Services and expose options work.
- [Security](https://operator.docs.scylladb.com/v1.21/understand/security.md) — TLS certificate management.
