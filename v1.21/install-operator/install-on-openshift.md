...
- An OpenShift Container Platform cluster meeting the [infrastructure requirements](https://operator.docs.scylladb.com/v1.21/install-operator/provision-infrastructure/index.md).
...
- [Install with GitOps](https://operator.docs.scylladb.com/v1.21/install-operator/install-with-gitops.md) — alternative installation path using manifests (generic Kubernetes).
- [Install with Helm](https://operator.docs.scylladb.com/v1.21/install-operator/install-with-helm.md) — alternative installation path using Helm charts.
- [Upgrade ScyllaDB Operator](https://operator.docs.scylladb.com/v1.21/upgrade/upgrade-operator.md) — version-specific upgrade steps.
