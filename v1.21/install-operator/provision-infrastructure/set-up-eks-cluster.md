...
- Follow the [Reference deployment: EKS](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/reference-deployments/reference-deployment-eks.md) for a complete ScyllaDB deployment on this cluster.
