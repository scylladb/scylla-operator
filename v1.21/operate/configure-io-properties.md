...
- [Pass additional ScyllaDB arguments](https://operator.docs.scylladb.com/v1.21/operate/pass-scylladb-arguments.md) — passing arbitrary command-line flags to ScyllaDB
