...
- [Scale, add, remove racks](https://operator.docs.scylladb.com/v1.21/operate/scale-add-remove-racks.md) — changing the number of nodes instead of the volume size
- [StatefulSets and racks](https://operator.docs.scylladb.com/v1.21/understand/statefulsets-and-racks.md) — why each rack maps to a StatefulSet and what constraints that implies
- [Replace nodes](https://operator.docs.scylladb.com/v1.21/operate/replace-nodes.md) — replacing a node with a fresh PVC rather than expanding the existing one
