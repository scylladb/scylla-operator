...
- [StatefulSets and racks](https://operator.docs.scylladb.com/v1.21/understand/statefulsets-and-racks.md) — how StatefulSets manage rolling updates with partition-based rollouts
- [Upgrade ScyllaDB](https://operator.docs.scylladb.com/v1.21/upgrade/upgrade-scylladb.md) — version upgrades that include an automatic rolling restart
