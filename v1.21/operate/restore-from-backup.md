...
Restore from backup taken using [ScyllaDB Manager](https://operator.docs.scylladb.com/v1.21/understand/manager.md) to a fresh **empty** cluster of any size.
...
- [Back up and restore](https://operator.docs.scylladb.com/v1.21/operate/back-up-and-restore.md) — overview of backup and restore with ScyllaDB Manager.
- [ScyllaDB Manager](https://operator.docs.scylladb.com/v1.21/understand/manager.md) — how Manager integrates with the Operator.
