...
For setup instructions, see [IPv6 networking](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-networking/ipv6/index.md).
...
- [Configure dual-stack networking](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-networking/ipv6/configure-dual-stack.md)
- [Get started with IPv6](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-networking/ipv6/get-started.md)
