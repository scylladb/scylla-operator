...
See [Conditions](https://operator.docs.scylladb.com/v1.21/reference/conditions.md) for a detailed reference.
...
- [Limit collection to a particular namespace](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/must-gather.md#limit-collection-to-a-particular-namespace) by passing the `--namespace` flag.
- [Exclude resources](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/must-gather.md#exclude-resources) by passing the `--exclude-resource` flag.
...
- [Collect data with must-gather](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/must-gather.md)
- [Query system tables](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/system-tables.md)
