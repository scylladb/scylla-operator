...
See [must-gather contents](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/must-gather-contents.md) for details on navigating the archive.
...
- [must-gather contents](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/must-gather-contents.md)
