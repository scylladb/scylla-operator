...
| Use case                                                                  | Tool                                                                                                                          |
|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| Kubernetes-level diagnostics (pod status, events, logs)                   | [Collect debugging information](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/index.md) |
