...
```bash
curl -fLO https://raw.githubusercontent.com/scylladb/scylla-operator/v1.21/examples/gke/coredumps/coredump-conf.configmap.yaml
```
...
```bash
kubectl apply --server-side -f=https://raw.githubusercontent.com/scylladb/scylla-operator/v1.21/examples/gke/coredumps/setup-systemd-coredump.daemonset.yaml
```
