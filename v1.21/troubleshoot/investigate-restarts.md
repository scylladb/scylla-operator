...
- See [Set up dedicated node pools](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/before-you-deploy/set-up-dedicated-node-pools.md).
...
- [Collecting debugging information](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/index.md)
