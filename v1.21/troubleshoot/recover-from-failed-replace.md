...
For normal node replacement, see [Replace nodes](https://operator.docs.scylladb.com/v1.21/operate/replace-nodes.md).
...
See [Collect debugging information](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/index.md) for instructions.
...
- [StatefulSets and racks](https://operator.docs.scylladb.com/v1.21/understand/statefulsets-and-racks.md)
- [Collect debugging information](https://operator.docs.scylladb.com/v1.21/troubleshoot/collect-debugging-information/index.md)
