...
- [Understand](https://operator.docs.scylladb.com/v1.21/understand/index.md) — component diagram and reconciliation model.
- [Sidecar](https://operator.docs.scylladb.com/v1.21/understand/sidecar.md) — the sidecar that reports node status used for stability checks.
