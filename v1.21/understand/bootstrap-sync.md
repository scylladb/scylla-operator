...
See [Feature gates](https://operator.docs.scylladb.com/v1.21/reference/feature-gates.md) for instructions on enabling feature gates.
...
- [Ignition](https://operator.docs.scylladb.com/v1.21/understand/ignition.md) — the startup gating mechanism that runs after the bootstrap barrier.
- [Sidecar](https://operator.docs.scylladb.com/v1.21/understand/sidecar.md) — the sidecar container that runs the StatusReporter.
- [Understand](https://operator.docs.scylladb.com/v1.21/understand/index.md) — component diagram and CRD list.
