...
See [Deploy a multi-datacenter cluster](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/deploy-multi-datacenter-cluster.md) for deployment guides.
...
The Operator supports IPv4, IPv6, and dual-stack networking. See [IPv6](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/set-up-networking/ipv6/index.md) for configuration details.
...
The Operator does **not** create Kubernetes `NetworkPolicy` resources. If your environment requires network-level isolation, you must create NetworkPolicy objects separately. See [Security](https://operator.docs.scylladb.com/v1.21/understand/security.md) for related considerations.

## Related pages

- [Understand](https://operator.docs.scylladb.com/v1.21/understand/index.md) — component diagram and CRD summary.
- [Security](https://operator.docs.scylladb.com/v1.21/understand/security.md) — TLS certificates and authentication.
- [Sidecar](https://operator.docs.scylladb.com/v1.21/understand/sidecar.md) — how the sidecar resolves broadcast addresses at startup.
- [StatefulSets and racks](https://operator.docs.scylladb.com/v1.21/understand/statefulsets-and-racks.md) — StatefulSet naming and stable network identity.
