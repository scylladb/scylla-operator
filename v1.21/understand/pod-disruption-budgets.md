...
- [Statefulsets and racks](https://operator.docs.scylladb.com/v1.21/understand/statefulsets-and-racks.md) — rolling update strategy and partition-based rollout.
- [Understand](https://operator.docs.scylladb.com/v1.21/understand/index.md) — reconciliation model.
