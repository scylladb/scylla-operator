...
|   3 | `scylladb-ignition`         | Operator      | Evaluates startup prerequisites (tuning done, IPs assigned, container running) and creates the ignition signal file when all are met. See [Ignition](https://operator.docs.scylladb.com/v1.21/understand/ignition.md). | Always present                              |
...
This mechanism ensures that ScyllaDB never starts before node-level tuning is complete and network addresses are assigned. See [Ignition](https://operator.docs.scylladb.com/v1.21/understand/ignition.md) for the full list of prerequisites.
...
- Updates the Service annotations with the current host ID and token ring hash. These annotations are consumed by the datacenter controller to detect token ring changes (for [automatic data cleanup](https://operator.docs.scylladb.com/v1.21/understand/automatic-data-cleanup.md)) and to track node identity.
...
- [Ignition](https://operator.docs.scylladb.com/v1.21/understand/ignition.md) — detailed startup prerequisites and the ignition controller.
- [Bootstrap synchronisation](https://operator.docs.scylladb.com/v1.21/understand/bootstrap-sync.md) — the barrier init container.
- [Tuning](https://operator.docs.scylladb.com/v1.21/understand/tuning.md) — how node tuning feeds into ignition readiness.
- [Networking](https://operator.docs.scylladb.com/v1.21/understand/networking.md) — broadcast address types and Service model.
- [Security](https://operator.docs.scylladb.com/v1.21/understand/security.md) — TLS certificates mounted into pod containers and Manager Agent authentication.
- [StatefulSets and racks](https://operator.docs.scylladb.com/v1.21/understand/statefulsets-and-racks.md) — pod identity, scaling, and decommission flow.
