...
Performance tuning is enabled when you create a [NodeConfig](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/before-you-deploy/configure-nodes.md) resource that targets your ScyllaDB nodes.
...
Both node-level and container-level tuning **block ScyllaDB startup** via the [ignition](https://operator.docs.scylladb.com/v1.21/understand/ignition.md) mechanism.
...
Container-level tuning **blocks ScyllaDB startup via the [ignition](https://operator.docs.scylladb.com/v1.21/understand/ignition.md) mechanism**.
...
For a step-by-step guide on configuring CPU pinning, see [CPU Pinning](https://operator.docs.scylladb.com/v1.21/deploy-scylladb/before-you-deploy/configure-cpu-pinning.md).
