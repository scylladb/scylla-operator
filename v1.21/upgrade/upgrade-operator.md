...
Please refer to the [GitOps installation instructions](https://operator.docs.scylladb.com/v1.21/install-operator/install-with-gitops.md) for details.
...
- Update ScyllaDB Operator dependencies to the versions compatible with the target ScyllaDB Operator version.
  Refer to the [Helm installation instructions](https://operator.docs.scylladb.com/v1.21/install-operator/install-with-helm.md) for details.
