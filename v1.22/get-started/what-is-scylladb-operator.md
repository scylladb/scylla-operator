...
- **ScyllaDB Manager auth token synchronization** — when ScyllaDB Manager is deployed in one datacenter, its auth token Secret must be manually copied to each other datacenter and the Manager Agent pods restarted. See [ScyllaDB Manager](https://operator.docs.scylladb.com/stable/understand/manager.md).
...
For the full support matrix including supported Kubernetes versions, ScyllaDB versions, and known platform incompatibilities, see [Releases](https://operator.docs.scylladb.com/stable/reference/releases.md).

## Next steps

- [Install](https://operator.docs.scylladb.com/stable/install-operator/index.md) ScyllaDB Operator in your Kubernetes cluster.
- [Deploy your first cluster](https://operator.docs.scylladb.com/stable/deploy-scylladb/deploy-your-first-cluster.md) once the Operator is installed.
- See a complete end-to-end walkthrough for [GKE](https://operator.docs.scylladb.com/stable/deploy-scylladb/reference-deployments/reference-deployment-gke.md), [EKS](https://operator.docs.scylladb.com/stable/deploy-scylladb/reference-deployments/reference-deployment-eks.md), or [OpenShift](https://operator.docs.scylladb.com/stable/deploy-scylladb/reference-deployments/reference-deployment-openshift.md).
- Learn about the Operator’s [architecture](https://operator.docs.scylladb.com/stable/understand/index.md).
