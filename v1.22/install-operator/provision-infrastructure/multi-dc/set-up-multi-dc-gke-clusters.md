...
The interconnected clusters can serve as a platform for [deploying a Multi Datacenter ScyllaDB cluster](https://operator.docs.scylladb.com/stable/deploy-scylladb/deploy-multi-datacenter-cluster.md).
...
To deploy ScyllaDB Operator follow the [installation guide](https://operator.docs.scylladb.com/stable/install-operator/index.md).
...
Refer to [Deploy a multi-datacenter ScyllaDB cluster in multiple interconnected Kubernetes clusters](https://operator.docs.scylladb.com/stable/deploy-scylladb/deploy-multi-datacenter-cluster.md) in ScyllaDB Operator documentation for guidance.
