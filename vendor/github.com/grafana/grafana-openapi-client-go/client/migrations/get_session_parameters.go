...
// WithUID adds the uid to the get session params
func (o *GetSessionParams) WithUID(uid string) *GetSessionParams {
	o.SetUID(uid)
	return o
}

// SetUID adds the uid to the get session params
func (o *GetSessionParams) SetUID(uid string) {
	o.UID = uid
}
