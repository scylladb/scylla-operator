...
RenderReportCSVsParams contains all the parameters to send to the API endpoint
	...
	for the render report CSVs operation.
...
// WithDefaults hydrates default values in the render report CSVs params (not the query body).
//
...
// SetDefaults hydrates default values in the render report CSVs params (not the query body).
//
// All values with no default are reset to their zero value.
