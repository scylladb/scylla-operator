...
RenderReportPDFsParams contains all the parameters to send to the API endpoint
	...
	for the render report PDFs operation.
...
// WithDefaults hydrates default values in the render report PDFs params (not the query body).
//
...
// SetDefaults hydrates default values in the render report PDFs params (not the query body).
//
// All values with no default are reset to their zero value.
