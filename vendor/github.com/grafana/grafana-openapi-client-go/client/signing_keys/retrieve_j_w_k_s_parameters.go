...
// NewRetrieveJWKSParams creates a new RetrieveJWKSParams object,
...
func NewRetrieveJWKSParams() *RetrieveJWKSParams {
	return &RetrieveJWKSParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewRetrieveJWKSParamsWithTimeout creates a new RetrieveJWKSParams object
...
// NewRetrieveJWKSParamsWithContext creates a new RetrieveJWKSParams object
...
// NewRetrieveJWKSParamsWithHTTPClient creates a new RetrieveJWKSParams object
...
RetrieveJWKSParams contains all the parameters to send to the API endpoint
	...
	for the retrieve j w k s operation.

	Typically these are written to a http.Request.
*/
type RetrieveJWKSParams struct {
