...
func (m *GettableAPIReceiver) validateMsteamsv2Configs(formats strfmt.Registry) error {
...
func (m *GettableAPIReceiver) contextValidateMsteamsv2Configs(ctx context.Context, formats strfmt.Registry) error {
