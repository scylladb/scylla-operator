...
func (m *PostableAPIReceiver) validateJiraConfigs(formats strfmt.Registry) error {
...
func (m *PostableAPIReceiver) validateMsteamsConfigs(formats strfmt.Registry) error {
...
func (m *PostableAPIReceiver) contextValidateJiraConfigs(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PostableAPIReceiver) contextValidateMsteamsConfigs(ctx context.Context, formats strfmt.Registry) error {
