...
var provisionedAlertRuleTypeExecErrStatePropEnum []any
...
var provisionedAlertRuleTypeNoDataStatePropEnum []any
...
func (m *ProvisionedAlertRule) contextValidateUpdated(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := validate.ReadOnly(ctx, "updated", "body", m.Updated); err != nil {
		return err
	}
