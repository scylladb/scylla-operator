...
func (m *SetPermissionsCommand) validatePermissions(formats strfmt.Registry) error {
...
func (m *SetPermissionsCommand) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {
