...
func (o *CacheServiceKeyCacheSavePeriodPostOK) Error() string {
	return fmt.Sprintf("[POST /cache_service/key_cache_save_period][%d] cacheServiceKeyCacheSavePeriodPostOK ", 200)
}
