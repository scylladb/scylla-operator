...
func (o *CacheServiceMetricsKeySizeGetOK) Error() string {
	return fmt.Sprintf("[GET /cache_service/metrics/key/size][%d] cacheServiceMetricsKeySizeGetOK  %+v", 200, o.Payload)
}
