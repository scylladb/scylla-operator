...
func (o *CacheServiceMetricsRowHitRateGetOK) Error() string {
	return fmt.Sprintf("[GET /cache_service/metrics/row/hit_rate][%d] cacheServiceMetricsRowHitRateGetOK  %+v", 200, o.Payload)
}
