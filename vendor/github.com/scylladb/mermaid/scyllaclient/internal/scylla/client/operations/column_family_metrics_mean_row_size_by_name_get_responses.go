...
func (o *ColumnFamilyMetricsMeanRowSizeByNameGetOK) Error() string {
	return fmt.Sprintf("[GET /column_family/metrics/mean_row_size/{name}][%d] columnFamilyMetricsMeanRowSizeByNameGetOK  %+v", 200, o.Payload)
}
