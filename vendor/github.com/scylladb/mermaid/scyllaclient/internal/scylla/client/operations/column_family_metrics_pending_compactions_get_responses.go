...
func (o *ColumnFamilyMetricsPendingCompactionsGetOK) Error() string {
	return fmt.Sprintf("[GET /column_family/metrics/pending_compactions][%d] columnFamilyMetricsPendingCompactionsGetOK  %+v", 200, o.Payload)
}
