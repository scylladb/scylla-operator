...
func (o *ColumnFamilyMetricsReadByNameGetOK) Error() string {
	return fmt.Sprintf("[GET /column_family/metrics/read/{name}][%d] columnFamilyMetricsReadByNameGetOK  %+v", 200, o.Payload)
}
