...
func (o *ColumnFamilyMetricsReadLatencyHistogramGetOK) Error() string {
	return fmt.Sprintf("[GET /column_family/metrics/read_latency/histogram/][%d] columnFamilyMetricsReadLatencyHistogramGetOK  %+v", 200, o.Payload)
}
