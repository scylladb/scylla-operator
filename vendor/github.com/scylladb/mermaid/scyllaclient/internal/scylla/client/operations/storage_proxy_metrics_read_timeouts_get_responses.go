...
func (o *StorageProxyMetricsReadTimeoutsGetOK) Error() string {
	return fmt.Sprintf("[GET /storage_proxy/metrics/read/timeouts][%d] storageProxyMetricsReadTimeoutsGetOK  %+v", 200, o.Payload)
}
