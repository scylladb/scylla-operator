...
func (o *StorageServiceKeyspaceScrubByKeyspaceGetOK) Error() string {
	return fmt.Sprintf("[GET /storage_service/keyspace_scrub/{keyspace}][%d] storageServiceKeyspaceScrubByKeyspaceGetOK  %+v", 200, o.Payload)
}
