...
func (o *StorageServiceMetricsHintsInProgressGetOK) Error() string {
	return fmt.Sprintf("[GET /storage_service/metrics/hints_in_progress][%d] storageServiceMetricsHintsInProgressGetOK  %+v", 200, o.Payload)
}
