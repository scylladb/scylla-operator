...
func (o *StorageServiceMetricsLoadGetOK) Error() string {
	return fmt.Sprintf("[GET /storage_service/metrics/load][%d] storageServiceMetricsLoadGetOK  %+v", 200, o.Payload)
}
