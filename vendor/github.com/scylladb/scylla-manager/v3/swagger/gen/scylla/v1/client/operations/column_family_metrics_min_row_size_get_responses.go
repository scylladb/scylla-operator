...
func (o *ColumnFamilyMetricsMinRowSizeGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewColumnFamilyMetricsMinRowSizeGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewColumnFamilyMetricsMinRowSizeGetDefault(code int) *ColumnFamilyMetricsMinRowSizeGetDefault {
	return &ColumnFamilyMetricsMinRowSizeGetDefault{
		_statusCode: code,
	}
}
...
func (o *ColumnFamilyMetricsMinRowSizeGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
