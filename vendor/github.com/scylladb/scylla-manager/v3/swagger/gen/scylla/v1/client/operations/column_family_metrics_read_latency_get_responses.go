...
func (o *ColumnFamilyMetricsReadLatencyGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewColumnFamilyMetricsReadLatencyGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewColumnFamilyMetricsReadLatencyGetDefault(code int) *ColumnFamilyMetricsReadLatencyGetDefault {
	return &ColumnFamilyMetricsReadLatencyGetDefault{
		_statusCode: code,
	}
}
...
func (o *ColumnFamilyMetricsReadLatencyGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
