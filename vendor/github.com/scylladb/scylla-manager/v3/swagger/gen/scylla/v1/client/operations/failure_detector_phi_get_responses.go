...
func (o *FailureDetectorPhiGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewFailureDetectorPhiGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewFailureDetectorPhiGetDefault(code int) *FailureDetectorPhiGetDefault {
	return &FailureDetectorPhiGetDefault{
		_statusCode: code,
	}
}
...
func (o *FailureDetectorPhiGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
