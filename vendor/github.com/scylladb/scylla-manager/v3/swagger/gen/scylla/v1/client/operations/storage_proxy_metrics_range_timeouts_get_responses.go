...
func (o *StorageProxyMetricsRangeTimeoutsGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewStorageProxyMetricsRangeTimeoutsGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewStorageProxyMetricsRangeTimeoutsGetDefault(code int) *StorageProxyMetricsRangeTimeoutsGetDefault {
	return &StorageProxyMetricsRangeTimeoutsGetDefault{
		_statusCode: code,
	}
}
...
func (o *StorageProxyMetricsRangeTimeoutsGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
