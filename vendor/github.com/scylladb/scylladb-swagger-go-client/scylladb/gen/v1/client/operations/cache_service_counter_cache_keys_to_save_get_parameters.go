...
CacheServiceCounterCacheKeysToSaveGetParams contains all the parameters to send to the API endpoint
	...
	for the cache service counter cache keys to save get operation.
...
// WithDefaults hydrates default values in the cache service counter cache keys to save get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceCounterCacheKeysToSaveGetParams) WithDefaults() *CacheServiceCounterCacheKeysToSaveGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service counter cache keys to save get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceCounterCacheKeysToSaveGetParams) SetDefaults() {
