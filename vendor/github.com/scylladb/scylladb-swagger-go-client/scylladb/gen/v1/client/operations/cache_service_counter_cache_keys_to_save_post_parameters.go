...
CacheServiceCounterCacheKeysToSavePostParams contains all the parameters to send to the API endpoint
	...
	for the cache service counter cache keys to save post operation.
...
// WithDefaults hydrates default values in the cache service counter cache keys to save post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceCounterCacheKeysToSavePostParams) WithDefaults() *CacheServiceCounterCacheKeysToSavePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service counter cache keys to save post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceCounterCacheKeysToSavePostParams) SetDefaults() {
