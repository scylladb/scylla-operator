...
CacheServiceInvalidateCounterCachePostParams contains all the parameters to send to the API endpoint
	...
	for the cache service invalidate counter cache post operation.
...
// WithDefaults hydrates default values in the cache service invalidate counter cache post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceInvalidateCounterCachePostParams) WithDefaults() *CacheServiceInvalidateCounterCachePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service invalidate counter cache post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceInvalidateCounterCachePostParams) SetDefaults() {
