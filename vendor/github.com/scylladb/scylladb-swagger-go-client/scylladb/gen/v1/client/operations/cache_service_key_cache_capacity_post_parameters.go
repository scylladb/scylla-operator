...
CacheServiceKeyCacheCapacityPostParams contains all the parameters to send to the API endpoint
	...
	for the cache service key cache capacity post operation.
...
// WithDefaults hydrates default values in the cache service key cache capacity post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceKeyCacheCapacityPostParams) WithDefaults() *CacheServiceKeyCacheCapacityPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service key cache capacity post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceKeyCacheCapacityPostParams) SetDefaults() {
