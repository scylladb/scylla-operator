...
CacheServiceKeyCacheSavePeriodGetParams contains all the parameters to send to the API endpoint
	...
	for the cache service key cache save period get operation.
...
// WithDefaults hydrates default values in the cache service key cache save period get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceKeyCacheSavePeriodGetParams) WithDefaults() *CacheServiceKeyCacheSavePeriodGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service key cache save period get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceKeyCacheSavePeriodGetParams) SetDefaults() {
