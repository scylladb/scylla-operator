...
CacheServiceKeyCacheSavePeriodPostParams contains all the parameters to send to the API endpoint
	...
	for the cache service key cache save period post operation.
...
// WithDefaults hydrates default values in the cache service key cache save period post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceKeyCacheSavePeriodPostParams) WithDefaults() *CacheServiceKeyCacheSavePeriodPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service key cache save period post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceKeyCacheSavePeriodPostParams) SetDefaults() {
