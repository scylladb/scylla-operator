...
CacheServiceMetricsCounterRequestsGetParams contains all the parameters to send to the API endpoint
	...
	for the cache service metrics counter requests get operation.
...
// WithDefaults hydrates default values in the cache service metrics counter requests get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceMetricsCounterRequestsGetParams) WithDefaults() *CacheServiceMetricsCounterRequestsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service metrics counter requests get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceMetricsCounterRequestsGetParams) SetDefaults() {
