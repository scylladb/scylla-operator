...
CacheServiceMetricsKeyHitRateGetParams contains all the parameters to send to the API endpoint
	...
	for the cache service metrics key hit rate get operation.
...
// WithDefaults hydrates default values in the cache service metrics key hit rate get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceMetricsKeyHitRateGetParams) WithDefaults() *CacheServiceMetricsKeyHitRateGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service metrics key hit rate get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceMetricsKeyHitRateGetParams) SetDefaults() {
