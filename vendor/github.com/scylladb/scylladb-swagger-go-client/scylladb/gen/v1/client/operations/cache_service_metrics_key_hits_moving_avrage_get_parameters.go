...
CacheServiceMetricsKeyHitsMovingAvrageGetParams contains all the parameters to send to the API endpoint
	...
	for the cache service metrics key hits moving avrage get operation.
...
// WithDefaults hydrates default values in the cache service metrics key hits moving avrage get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceMetricsKeyHitsMovingAvrageGetParams) WithDefaults() *CacheServiceMetricsKeyHitsMovingAvrageGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service metrics key hits moving avrage get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceMetricsKeyHitsMovingAvrageGetParams) SetDefaults() {
