...
CacheServiceSaveCachesPostParams contains all the parameters to send to the API endpoint
	...
	for the cache service save caches post operation.
...
// WithDefaults hydrates default values in the cache service save caches post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceSaveCachesPostParams) WithDefaults() *CacheServiceSaveCachesPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the cache service save caches post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CacheServiceSaveCachesPostParams) SetDefaults() {
