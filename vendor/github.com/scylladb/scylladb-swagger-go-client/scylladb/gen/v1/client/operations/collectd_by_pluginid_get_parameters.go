...
CollectdByPluginidGetParams contains all the parameters to send to the API endpoint
	...
	for the collectd by pluginid get operation.
...
// WithDefaults hydrates default values in the collectd by pluginid get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdByPluginidGetParams) WithDefaults() *CollectdByPluginidGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the collectd by pluginid get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdByPluginidGetParams) SetDefaults() {
