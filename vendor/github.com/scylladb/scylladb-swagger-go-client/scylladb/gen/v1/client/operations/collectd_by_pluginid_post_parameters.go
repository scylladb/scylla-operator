...
CollectdByPluginidPostParams contains all the parameters to send to the API endpoint
	...
	for the collectd by pluginid post operation.
...
// WithDefaults hydrates default values in the collectd by pluginid post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdByPluginidPostParams) WithDefaults() *CollectdByPluginidPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the collectd by pluginid post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdByPluginidPostParams) SetDefaults() {
