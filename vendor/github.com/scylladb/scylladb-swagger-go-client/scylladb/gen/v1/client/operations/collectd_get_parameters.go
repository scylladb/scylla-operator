...
CollectdGetParams contains all the parameters to send to the API endpoint
	...
	for the collectd get operation.
...
// WithDefaults hydrates default values in the collectd get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdGetParams) WithDefaults() *CollectdGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the collectd get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdGetParams) SetDefaults() {
