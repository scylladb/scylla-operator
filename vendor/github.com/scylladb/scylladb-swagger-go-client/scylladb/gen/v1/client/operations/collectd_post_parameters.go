...
CollectdPostParams contains all the parameters to send to the API endpoint
	...
	for the collectd post operation.
...
// WithDefaults hydrates default values in the collectd post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdPostParams) WithDefaults() *CollectdPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the collectd post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CollectdPostParams) SetDefaults() {
