...
ColumnFamilyCompactionStrategyByNamePostParams contains all the parameters to send to the API endpoint
	...
	for the column family compaction strategy by name post operation.
...
// WithDefaults hydrates default values in the column family compaction strategy by name post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyCompactionStrategyByNamePostParams) WithDefaults() *ColumnFamilyCompactionStrategyByNamePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family compaction strategy by name post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyCompactionStrategyByNamePostParams) SetDefaults() {
