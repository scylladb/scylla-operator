...
ColumnFamilyCompressionParametersByNamePostParams contains all the parameters to send to the API endpoint
	...
	for the column family compression parameters by name post operation.
...
// WithDefaults hydrates default values in the column family compression parameters by name post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyCompressionParametersByNamePostParams) WithDefaults() *ColumnFamilyCompressionParametersByNamePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family compression parameters by name post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyCompressionParametersByNamePostParams) SetDefaults() {
