...
ColumnFamilyGetParams contains all the parameters to send to the API endpoint
	...
	for the column family get operation.
...
// WithDefaults hydrates default values in the column family get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyGetParams) WithDefaults() *ColumnFamilyGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyGetParams) SetDefaults() {
