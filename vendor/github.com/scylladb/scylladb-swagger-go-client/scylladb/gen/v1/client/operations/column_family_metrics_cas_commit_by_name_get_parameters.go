...
// NewColumnFamilyMetricsCasCommitByNameGetParams creates a new ColumnFamilyMetricsCasCommitByNameGetParams object,
...
func NewColumnFamilyMetricsCasCommitByNameGetParams() *ColumnFamilyMetricsCasCommitByNameGetParams {
	return &ColumnFamilyMetricsCasCommitByNameGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyMetricsCasCommitByNameGetParamsWithTimeout creates a new ColumnFamilyMetricsCasCommitByNameGetParams object
...
// NewColumnFamilyMetricsCasCommitByNameGetParamsWithContext creates a new ColumnFamilyMetricsCasCommitByNameGetParams object
...
// NewColumnFamilyMetricsCasCommitByNameGetParamsWithHTTPClient creates a new ColumnFamilyMetricsCasCommitByNameGetParams object
...
/*
ColumnFamilyMetricsCasCommitByNameGetParams contains all the parameters to send to the API endpoint

	for the column family metrics cas commit by name get operation.
...
// WithDefaults hydrates default values in the column family metrics cas commit by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsCasCommitByNameGetParams) WithDefaults() *ColumnFamilyMetricsCasCommitByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics cas commit by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsCasCommitByNameGetParams) SetDefaults() {
