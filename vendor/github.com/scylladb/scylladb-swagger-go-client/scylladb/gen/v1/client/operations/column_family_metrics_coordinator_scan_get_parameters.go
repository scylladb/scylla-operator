...
// NewColumnFamilyMetricsCoordinatorScanGetParams creates a new ColumnFamilyMetricsCoordinatorScanGetParams object,
...
func NewColumnFamilyMetricsCoordinatorScanGetParams() *ColumnFamilyMetricsCoordinatorScanGetParams {
	return &ColumnFamilyMetricsCoordinatorScanGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyMetricsCoordinatorScanGetParamsWithTimeout creates a new ColumnFamilyMetricsCoordinatorScanGetParams object
...
// NewColumnFamilyMetricsCoordinatorScanGetParamsWithContext creates a new ColumnFamilyMetricsCoordinatorScanGetParams object
...
// NewColumnFamilyMetricsCoordinatorScanGetParamsWithHTTPClient creates a new ColumnFamilyMetricsCoordinatorScanGetParams object
...
ColumnFamilyMetricsCoordinatorScanGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics coordinator scan get operation.
...
// WithDefaults hydrates default values in the column family metrics coordinator scan get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsCoordinatorScanGetParams) WithDefaults() *ColumnFamilyMetricsCoordinatorScanGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics coordinator scan get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsCoordinatorScanGetParams) SetDefaults() {
