...
func (o *ColumnFamilyMetricsEstimatedRowCountByNameGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewColumnFamilyMetricsEstimatedRowCountByNameGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewColumnFamilyMetricsEstimatedRowCountByNameGetDefault(code int) *ColumnFamilyMetricsEstimatedRowCountByNameGetDefault {
	return &ColumnFamilyMetricsEstimatedRowCountByNameGetDefault{
		_statusCode: code,
	}
}
...
func (o *ColumnFamilyMetricsEstimatedRowCountByNameGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
