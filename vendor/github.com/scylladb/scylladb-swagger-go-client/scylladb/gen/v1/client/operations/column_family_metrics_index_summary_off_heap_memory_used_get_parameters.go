...
ColumnFamilyMetricsIndexSummaryOffHeapMemoryUsedGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics index summary off heap memory used get operation.
...
// WithDefaults hydrates default values in the column family metrics index summary off heap memory used get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsIndexSummaryOffHeapMemoryUsedGetParams) WithDefaults() *ColumnFamilyMetricsIndexSummaryOffHeapMemoryUsedGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics index summary off heap memory used get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsIndexSummaryOffHeapMemoryUsedGetParams) SetDefaults() {
