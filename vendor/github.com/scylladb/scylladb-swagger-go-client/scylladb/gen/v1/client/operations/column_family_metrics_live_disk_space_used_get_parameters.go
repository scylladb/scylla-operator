...
ColumnFamilyMetricsLiveDiskSpaceUsedGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics live disk space used get operation.
...
// WithDefaults hydrates default values in the column family metrics live disk space used get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsLiveDiskSpaceUsedGetParams) WithDefaults() *ColumnFamilyMetricsLiveDiskSpaceUsedGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics live disk space used get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsLiveDiskSpaceUsedGetParams) SetDefaults() {
