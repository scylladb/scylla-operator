...
ColumnFamilyMetricsLiveSsTableCountGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics live ss table count get operation.
...
// WithDefaults hydrates default values in the column family metrics live ss table count get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsLiveSsTableCountGetParams) WithDefaults() *ColumnFamilyMetricsLiveSsTableCountGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics live ss table count get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsLiveSsTableCountGetParams) SetDefaults() {
