...
ColumnFamilyMetricsMeanRowSizeByNameGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics mean row size by name get operation.
...
// WithDefaults hydrates default values in the column family metrics mean row size by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMeanRowSizeByNameGetParams) WithDefaults() *ColumnFamilyMetricsMeanRowSizeByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics mean row size by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMeanRowSizeByNameGetParams) SetDefaults() {
