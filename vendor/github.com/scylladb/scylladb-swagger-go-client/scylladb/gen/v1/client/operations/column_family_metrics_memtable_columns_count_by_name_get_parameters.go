...
ColumnFamilyMetricsMemtableColumnsCountByNameGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics memtable columns count by name get operation.
...
// WithDefaults hydrates default values in the column family metrics memtable columns count by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMemtableColumnsCountByNameGetParams) WithDefaults() *ColumnFamilyMetricsMemtableColumnsCountByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics memtable columns count by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMemtableColumnsCountByNameGetParams) SetDefaults() {
