...
func (o *ColumnFamilyMetricsMemtableOnHeapSizeGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewColumnFamilyMetricsMemtableOnHeapSizeGetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewColumnFamilyMetricsMemtableOnHeapSizeGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewColumnFamilyMetricsMemtableOnHeapSizeGetOK() *ColumnFamilyMetricsMemtableOnHeapSizeGetOK {
	return &ColumnFamilyMetricsMemtableOnHeapSizeGetOK{}
}
...
func (o *ColumnFamilyMetricsMemtableOnHeapSizeGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewColumnFamilyMetricsMemtableOnHeapSizeGetDefault(code int) *ColumnFamilyMetricsMemtableOnHeapSizeGetDefault {
	return &ColumnFamilyMetricsMemtableOnHeapSizeGetDefault{
		_statusCode: code,
	}
}
...
func (o *ColumnFamilyMetricsMemtableOnHeapSizeGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
