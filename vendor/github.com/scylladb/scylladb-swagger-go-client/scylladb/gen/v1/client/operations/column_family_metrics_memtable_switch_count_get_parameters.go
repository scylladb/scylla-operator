...
ColumnFamilyMetricsMemtableSwitchCountGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics memtable switch count get operation.
...
// WithDefaults hydrates default values in the column family metrics memtable switch count get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMemtableSwitchCountGetParams) WithDefaults() *ColumnFamilyMetricsMemtableSwitchCountGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics memtable switch count get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMemtableSwitchCountGetParams) SetDefaults() {
