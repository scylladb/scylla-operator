...
ColumnFamilyMetricsMinRowSizeGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics min row size get operation.
...
// WithDefaults hydrates default values in the column family metrics min row size get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMinRowSizeGetParams) WithDefaults() *ColumnFamilyMetricsMinRowSizeGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics min row size get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsMinRowSizeGetParams) SetDefaults() {
