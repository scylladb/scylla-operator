...
// NewColumnFamilyMetricsPendingCompactionsGetParams creates a new ColumnFamilyMetricsPendingCompactionsGetParams object,
...
func NewColumnFamilyMetricsPendingCompactionsGetParams() *ColumnFamilyMetricsPendingCompactionsGetParams {
	return &ColumnFamilyMetricsPendingCompactionsGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyMetricsPendingCompactionsGetParamsWithTimeout creates a new ColumnFamilyMetricsPendingCompactionsGetParams object
...
// NewColumnFamilyMetricsPendingCompactionsGetParamsWithContext creates a new ColumnFamilyMetricsPendingCompactionsGetParams object
...
// NewColumnFamilyMetricsPendingCompactionsGetParamsWithHTTPClient creates a new ColumnFamilyMetricsPendingCompactionsGetParams object
...
/*
ColumnFamilyMetricsPendingCompactionsGetParams contains all the parameters to send to the API endpoint

	for the column family metrics pending compactions get operation.
...
// WithDefaults hydrates default values in the column family metrics pending compactions get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsPendingCompactionsGetParams) WithDefaults() *ColumnFamilyMetricsPendingCompactionsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics pending compactions get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsPendingCompactionsGetParams) SetDefaults() {
