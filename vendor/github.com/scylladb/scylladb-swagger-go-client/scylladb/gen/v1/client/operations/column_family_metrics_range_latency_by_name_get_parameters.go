...
// NewColumnFamilyMetricsRangeLatencyByNameGetParams creates a new ColumnFamilyMetricsRangeLatencyByNameGetParams object,
...
func NewColumnFamilyMetricsRangeLatencyByNameGetParams() *ColumnFamilyMetricsRangeLatencyByNameGetParams {
	return &ColumnFamilyMetricsRangeLatencyByNameGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyMetricsRangeLatencyByNameGetParamsWithTimeout creates a new ColumnFamilyMetricsRangeLatencyByNameGetParams object
...
// NewColumnFamilyMetricsRangeLatencyByNameGetParamsWithContext creates a new ColumnFamilyMetricsRangeLatencyByNameGetParams object
...
// NewColumnFamilyMetricsRangeLatencyByNameGetParamsWithHTTPClient creates a new ColumnFamilyMetricsRangeLatencyByNameGetParams object
...
ColumnFamilyMetricsRangeLatencyByNameGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics range latency by name get operation.
...
// WithDefaults hydrates default values in the column family metrics range latency by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsRangeLatencyByNameGetParams) WithDefaults() *ColumnFamilyMetricsRangeLatencyByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics range latency by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsRangeLatencyByNameGetParams) SetDefaults() {
