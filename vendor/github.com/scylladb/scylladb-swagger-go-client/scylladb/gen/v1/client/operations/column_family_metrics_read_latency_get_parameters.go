...
ColumnFamilyMetricsReadLatencyGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics read latency get operation.
...
// WithDefaults hydrates default values in the column family metrics read latency get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsReadLatencyGetParams) WithDefaults() *ColumnFamilyMetricsReadLatencyGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics read latency get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsReadLatencyGetParams) SetDefaults() {
