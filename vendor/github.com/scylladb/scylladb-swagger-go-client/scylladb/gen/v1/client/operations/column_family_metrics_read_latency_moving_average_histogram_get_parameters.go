...
ColumnFamilyMetricsReadLatencyMovingAverageHistogramGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics read latency moving average histogram get operation.
...
// WithDefaults hydrates default values in the column family metrics read latency moving average histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsReadLatencyMovingAverageHistogramGetParams) WithDefaults() *ColumnFamilyMetricsReadLatencyMovingAverageHistogramGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics read latency moving average histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsReadLatencyMovingAverageHistogramGetParams) SetDefaults() {
