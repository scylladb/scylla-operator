...
ColumnFamilyMetricsRecentBloomFilterFalseRatioGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics recent bloom filter false ratio get operation.
...
// WithDefaults hydrates default values in the column family metrics recent bloom filter false ratio get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsRecentBloomFilterFalseRatioGetParams) WithDefaults() *ColumnFamilyMetricsRecentBloomFilterFalseRatioGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics recent bloom filter false ratio get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsRecentBloomFilterFalseRatioGetParams) SetDefaults() {
