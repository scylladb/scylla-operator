...
// NewColumnFamilyMetricsRowCacheHitByNameGetParams creates a new ColumnFamilyMetricsRowCacheHitByNameGetParams object,
...
func NewColumnFamilyMetricsRowCacheHitByNameGetParams() *ColumnFamilyMetricsRowCacheHitByNameGetParams {
	return &ColumnFamilyMetricsRowCacheHitByNameGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyMetricsRowCacheHitByNameGetParamsWithTimeout creates a new ColumnFamilyMetricsRowCacheHitByNameGetParams object
...
// NewColumnFamilyMetricsRowCacheHitByNameGetParamsWithContext creates a new ColumnFamilyMetricsRowCacheHitByNameGetParams object
...
// NewColumnFamilyMetricsRowCacheHitByNameGetParamsWithHTTPClient creates a new ColumnFamilyMetricsRowCacheHitByNameGetParams object
...
/*
ColumnFamilyMetricsRowCacheHitByNameGetParams contains all the parameters to send to the API endpoint

	for the column family metrics row cache hit by name get operation.
...
// WithDefaults hydrates default values in the column family metrics row cache hit by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsRowCacheHitByNameGetParams) WithDefaults() *ColumnFamilyMetricsRowCacheHitByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics row cache hit by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsRowCacheHitByNameGetParams) SetDefaults() {
