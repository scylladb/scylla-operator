...
ColumnFamilyMetricsSpeculativeRetriesGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics speculative retries get operation.
...
// WithDefaults hydrates default values in the column family metrics speculative retries get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsSpeculativeRetriesGetParams) WithDefaults() *ColumnFamilyMetricsSpeculativeRetriesGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics speculative retries get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsSpeculativeRetriesGetParams) SetDefaults() {
