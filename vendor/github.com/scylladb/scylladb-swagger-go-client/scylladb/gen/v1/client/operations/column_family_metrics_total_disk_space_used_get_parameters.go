...
// NewColumnFamilyMetricsTotalDiskSpaceUsedGetParams creates a new ColumnFamilyMetricsTotalDiskSpaceUsedGetParams object,
...
// NewColumnFamilyMetricsTotalDiskSpaceUsedGetParamsWithTimeout creates a new ColumnFamilyMetricsTotalDiskSpaceUsedGetParams object
...
// NewColumnFamilyMetricsTotalDiskSpaceUsedGetParamsWithContext creates a new ColumnFamilyMetricsTotalDiskSpaceUsedGetParams object
...
// NewColumnFamilyMetricsTotalDiskSpaceUsedGetParamsWithHTTPClient creates a new ColumnFamilyMetricsTotalDiskSpaceUsedGetParams object
...
/*
ColumnFamilyMetricsTotalDiskSpaceUsedGetParams contains all the parameters to send to the API endpoint

	for the column family metrics total disk space used get operation.
...
// WithDefaults hydrates default values in the column family metrics total disk space used get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsTotalDiskSpaceUsedGetParams) WithDefaults() *ColumnFamilyMetricsTotalDiskSpaceUsedGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics total disk space used get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsTotalDiskSpaceUsedGetParams) SetDefaults() {
