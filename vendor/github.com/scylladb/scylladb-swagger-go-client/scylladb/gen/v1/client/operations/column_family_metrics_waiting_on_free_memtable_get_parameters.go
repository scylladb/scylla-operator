...
ColumnFamilyMetricsWaitingOnFreeMemtableGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics waiting on free memtable get operation.
...
// WithDefaults hydrates default values in the column family metrics waiting on free memtable get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsWaitingOnFreeMemtableGetParams) WithDefaults() *ColumnFamilyMetricsWaitingOnFreeMemtableGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics waiting on free memtable get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsWaitingOnFreeMemtableGetParams) SetDefaults() {
