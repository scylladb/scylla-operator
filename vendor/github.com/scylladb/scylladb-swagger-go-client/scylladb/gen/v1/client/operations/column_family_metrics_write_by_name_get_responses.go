...
func (o *ColumnFamilyMetricsWriteByNameGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewColumnFamilyMetricsWriteByNameGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewColumnFamilyMetricsWriteByNameGetDefault(code int) *ColumnFamilyMetricsWriteByNameGetDefault {
	return &ColumnFamilyMetricsWriteByNameGetDefault{
		_statusCode: code,
	}
}
...
func (o *ColumnFamilyMetricsWriteByNameGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
