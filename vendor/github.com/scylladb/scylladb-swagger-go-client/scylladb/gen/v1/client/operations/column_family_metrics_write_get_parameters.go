...
// NewColumnFamilyMetricsWriteGetParams creates a new ColumnFamilyMetricsWriteGetParams object,
...
func NewColumnFamilyMetricsWriteGetParams() *ColumnFamilyMetricsWriteGetParams {
	return &ColumnFamilyMetricsWriteGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyMetricsWriteGetParamsWithTimeout creates a new ColumnFamilyMetricsWriteGetParams object
...
// NewColumnFamilyMetricsWriteGetParamsWithContext creates a new ColumnFamilyMetricsWriteGetParams object
...
// NewColumnFamilyMetricsWriteGetParamsWithHTTPClient creates a new ColumnFamilyMetricsWriteGetParams object
...
/*
ColumnFamilyMetricsWriteGetParams contains all the parameters to send to the API endpoint

	for the column family metrics write get operation.
...
// WithDefaults hydrates default values in the column family metrics write get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsWriteGetParams) WithDefaults() *ColumnFamilyMetricsWriteGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics write get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsWriteGetParams) SetDefaults() {
