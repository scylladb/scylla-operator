...
ColumnFamilyMetricsWriteLatencyHistogramGetParams contains all the parameters to send to the API endpoint
	...
	for the column family metrics write latency histogram get operation.
...
// WithDefaults hydrates default values in the column family metrics write latency histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsWriteLatencyHistogramGetParams) WithDefaults() *ColumnFamilyMetricsWriteLatencyHistogramGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family metrics write latency histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyMetricsWriteLatencyHistogramGetParams) SetDefaults() {
