...
// NewColumnFamilyNameKeyspaceGetParams creates a new ColumnFamilyNameKeyspaceGetParams object,
...
func NewColumnFamilyNameKeyspaceGetParams() *ColumnFamilyNameKeyspaceGetParams {
	return &ColumnFamilyNameKeyspaceGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewColumnFamilyNameKeyspaceGetParamsWithTimeout creates a new ColumnFamilyNameKeyspaceGetParams object
...
// NewColumnFamilyNameKeyspaceGetParamsWithContext creates a new ColumnFamilyNameKeyspaceGetParams object
...
// NewColumnFamilyNameKeyspaceGetParamsWithHTTPClient creates a new ColumnFamilyNameKeyspaceGetParams object
...
ColumnFamilyNameKeyspaceGetParams contains all the parameters to send to the API endpoint
	...
	for the column family name keyspace get operation.
...
// WithDefaults hydrates default values in the column family name keyspace get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyNameKeyspaceGetParams) WithDefaults() *ColumnFamilyNameKeyspaceGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family name keyspace get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilyNameKeyspaceGetParams) SetDefaults() {
