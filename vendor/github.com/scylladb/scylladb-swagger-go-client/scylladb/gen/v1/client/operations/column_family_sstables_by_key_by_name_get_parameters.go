...
ColumnFamilySstablesByKeyByNameGetParams contains all the parameters to send to the API endpoint
	...
	for the column family sstables by key by name get operation.
...
// WithDefaults hydrates default values in the column family sstables by key by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilySstablesByKeyByNameGetParams) WithDefaults() *ColumnFamilySstablesByKeyByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the column family sstables by key by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ColumnFamilySstablesByKeyByNameGetParams) SetDefaults() {
