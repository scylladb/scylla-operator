...
CommitLogMetricsWaitingOnCommitGetParams contains all the parameters to send to the API endpoint
	...
	for the commit log metrics waiting on commit get operation.
...
// WithDefaults hydrates default values in the commit log metrics waiting on commit get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitLogMetricsWaitingOnCommitGetParams) WithDefaults() *CommitLogMetricsWaitingOnCommitGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the commit log metrics waiting on commit get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitLogMetricsWaitingOnCommitGetParams) SetDefaults() {
