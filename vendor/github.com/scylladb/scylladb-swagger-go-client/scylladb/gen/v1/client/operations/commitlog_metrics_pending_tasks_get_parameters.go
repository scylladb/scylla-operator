...
CommitlogMetricsPendingTasksGetParams contains all the parameters to send to the API endpoint
	...
	for the commitlog metrics pending tasks get operation.
...
// WithDefaults hydrates default values in the commitlog metrics pending tasks get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogMetricsPendingTasksGetParams) WithDefaults() *CommitlogMetricsPendingTasksGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the commitlog metrics pending tasks get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogMetricsPendingTasksGetParams) SetDefaults() {
