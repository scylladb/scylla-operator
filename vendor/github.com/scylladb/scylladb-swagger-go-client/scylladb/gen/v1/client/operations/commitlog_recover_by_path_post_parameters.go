...
// NewCommitlogRecoverByPathPostParams creates a new CommitlogRecoverByPathPostParams object,
...
func NewCommitlogRecoverByPathPostParams() *CommitlogRecoverByPathPostParams {
	return &CommitlogRecoverByPathPostParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCommitlogRecoverByPathPostParamsWithTimeout creates a new CommitlogRecoverByPathPostParams object
...
// NewCommitlogRecoverByPathPostParamsWithContext creates a new CommitlogRecoverByPathPostParams object
...
// NewCommitlogRecoverByPathPostParamsWithHTTPClient creates a new CommitlogRecoverByPathPostParams object
...
CommitlogRecoverByPathPostParams contains all the parameters to send to the API endpoint
	...
	for the commitlog recover by path post operation.
...
// WithDefaults hydrates default values in the commitlog recover by path post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogRecoverByPathPostParams) WithDefaults() *CommitlogRecoverByPathPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the commitlog recover by path post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogRecoverByPathPostParams) SetDefaults() {
