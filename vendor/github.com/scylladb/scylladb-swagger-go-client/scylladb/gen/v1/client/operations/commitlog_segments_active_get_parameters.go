...
CommitlogSegmentsActiveGetParams contains all the parameters to send to the API endpoint
	...
	for the commitlog segments active get operation.
...
// WithDefaults hydrates default values in the commitlog segments active get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogSegmentsActiveGetParams) WithDefaults() *CommitlogSegmentsActiveGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the commitlog segments active get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogSegmentsActiveGetParams) SetDefaults() {
