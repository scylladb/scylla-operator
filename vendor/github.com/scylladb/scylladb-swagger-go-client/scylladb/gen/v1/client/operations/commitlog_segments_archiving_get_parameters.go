...
CommitlogSegmentsArchivingGetParams contains all the parameters to send to the API endpoint
	...
	for the commitlog segments archiving get operation.
...
// WithDefaults hydrates default values in the commitlog segments archiving get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogSegmentsArchivingGetParams) WithDefaults() *CommitlogSegmentsArchivingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the commitlog segments archiving get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CommitlogSegmentsArchivingGetParams) SetDefaults() {
