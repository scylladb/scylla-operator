...
CompactionManagerCompactionHistoryGetParams contains all the parameters to send to the API endpoint
	...
	for the compaction manager compaction history get operation.
...
// WithDefaults hydrates default values in the compaction manager compaction history get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerCompactionHistoryGetParams) WithDefaults() *CompactionManagerCompactionHistoryGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the compaction manager compaction history get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerCompactionHistoryGetParams) SetDefaults() {
