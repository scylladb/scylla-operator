...
CompactionManagerCompactionInfoGetParams contains all the parameters to send to the API endpoint
	...
	for the compaction manager compaction info get operation.
...
// WithDefaults hydrates default values in the compaction manager compaction info get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerCompactionInfoGetParams) WithDefaults() *CompactionManagerCompactionInfoGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the compaction manager compaction info get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerCompactionInfoGetParams) SetDefaults() {
