...
CompactionManagerCompactionsGetParams contains all the parameters to send to the API endpoint
	...
	for the compaction manager compactions get operation.
...
// WithDefaults hydrates default values in the compaction manager compactions get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerCompactionsGetParams) WithDefaults() *CompactionManagerCompactionsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the compaction manager compactions get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerCompactionsGetParams) SetDefaults() {
