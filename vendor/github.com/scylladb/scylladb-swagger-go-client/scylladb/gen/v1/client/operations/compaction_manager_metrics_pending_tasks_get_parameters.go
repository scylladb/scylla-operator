...
CompactionManagerMetricsPendingTasksGetParams contains all the parameters to send to the API endpoint
	...
	for the compaction manager metrics pending tasks get operation.
...
// WithDefaults hydrates default values in the compaction manager metrics pending tasks get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerMetricsPendingTasksGetParams) WithDefaults() *CompactionManagerMetricsPendingTasksGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the compaction manager metrics pending tasks get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerMetricsPendingTasksGetParams) SetDefaults() {
