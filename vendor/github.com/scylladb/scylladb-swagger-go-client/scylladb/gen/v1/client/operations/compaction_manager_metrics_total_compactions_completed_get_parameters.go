...
CompactionManagerMetricsTotalCompactionsCompletedGetParams contains all the parameters to send to the API endpoint
	...
	for the compaction manager metrics total compactions completed get operation.
...
// WithDefaults hydrates default values in the compaction manager metrics total compactions completed get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerMetricsTotalCompactionsCompletedGetParams) WithDefaults() *CompactionManagerMetricsTotalCompactionsCompletedGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the compaction manager metrics total compactions completed get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CompactionManagerMetricsTotalCompactionsCompletedGetParams) SetDefaults() {
