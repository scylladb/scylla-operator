...
FailureDetectorCountEndpointDownGetParams contains all the parameters to send to the API endpoint
	...
	for the failure detector count endpoint down get operation.
...
// WithDefaults hydrates default values in the failure detector count endpoint down get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorCountEndpointDownGetParams) WithDefaults() *FailureDetectorCountEndpointDownGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the failure detector count endpoint down get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorCountEndpointDownGetParams) SetDefaults() {
