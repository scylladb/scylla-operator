...
FailureDetectorCountEndpointUpGetParams contains all the parameters to send to the API endpoint
	...
	for the failure detector count endpoint up get operation.
...
// WithDefaults hydrates default values in the failure detector count endpoint up get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorCountEndpointUpGetParams) WithDefaults() *FailureDetectorCountEndpointUpGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the failure detector count endpoint up get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorCountEndpointUpGetParams) SetDefaults() {
