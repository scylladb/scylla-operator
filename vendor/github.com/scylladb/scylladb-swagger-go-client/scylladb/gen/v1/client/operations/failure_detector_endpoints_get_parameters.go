...
FailureDetectorEndpointsGetParams contains all the parameters to send to the API endpoint
	...
	for the failure detector endpoints get operation.
...
// WithDefaults hydrates default values in the failure detector endpoints get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorEndpointsGetParams) WithDefaults() *FailureDetectorEndpointsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the failure detector endpoints get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorEndpointsGetParams) SetDefaults() {
