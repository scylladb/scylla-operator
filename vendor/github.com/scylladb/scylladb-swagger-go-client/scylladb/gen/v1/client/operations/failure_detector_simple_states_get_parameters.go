...
FailureDetectorSimpleStatesGetParams contains all the parameters to send to the API endpoint
	...
	for the failure detector simple states get operation.
...
// WithDefaults hydrates default values in the failure detector simple states get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorSimpleStatesGetParams) WithDefaults() *FailureDetectorSimpleStatesGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the failure detector simple states get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FailureDetectorSimpleStatesGetParams) SetDefaults() {
