...
GossiperEndpointLiveGetParams contains all the parameters to send to the API endpoint
	...
	for the gossiper endpoint live get operation.
...
// WithDefaults hydrates default values in the gossiper endpoint live get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GossiperEndpointLiveGetParams) WithDefaults() *GossiperEndpointLiveGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the gossiper endpoint live get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GossiperEndpointLiveGetParams) SetDefaults() {
