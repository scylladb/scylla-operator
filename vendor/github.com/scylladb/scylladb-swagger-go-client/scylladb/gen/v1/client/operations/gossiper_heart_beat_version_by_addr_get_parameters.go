...
GossiperHeartBeatVersionByAddrGetParams contains all the parameters to send to the API endpoint
	...
	for the gossiper heart beat version by addr get operation.
...
// WithDefaults hydrates default values in the gossiper heart beat version by addr get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GossiperHeartBeatVersionByAddrGetParams) WithDefaults() *GossiperHeartBeatVersionByAddrGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the gossiper heart beat version by addr get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GossiperHeartBeatVersionByAddrGetParams) SetDefaults() {
