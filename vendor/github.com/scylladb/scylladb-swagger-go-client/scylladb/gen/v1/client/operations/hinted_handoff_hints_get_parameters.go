...
HintedHandoffHintsGetParams contains all the parameters to send to the API endpoint
	...
	for the hinted handoff hints get operation.
...
// WithDefaults hydrates default values in the hinted handoff hints get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HintedHandoffHintsGetParams) WithDefaults() *HintedHandoffHintsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hinted handoff hints get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HintedHandoffHintsGetParams) SetDefaults() {
