...
HintedHandoffPausePostParams contains all the parameters to send to the API endpoint
	...
	for the hinted handoff pause post operation.
...
// WithDefaults hydrates default values in the hinted handoff pause post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HintedHandoffPausePostParams) WithDefaults() *HintedHandoffPausePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hinted handoff pause post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HintedHandoffPausePostParams) SetDefaults() {
