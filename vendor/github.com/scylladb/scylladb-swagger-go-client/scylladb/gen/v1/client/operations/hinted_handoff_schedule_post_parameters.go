...
HintedHandoffSchedulePostParams contains all the parameters to send to the API endpoint
	...
	for the hinted handoff schedule post operation.
...
// WithDefaults hydrates default values in the hinted handoff schedule post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HintedHandoffSchedulePostParams) WithDefaults() *HintedHandoffSchedulePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hinted handoff schedule post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HintedHandoffSchedulePostParams) SetDefaults() {
