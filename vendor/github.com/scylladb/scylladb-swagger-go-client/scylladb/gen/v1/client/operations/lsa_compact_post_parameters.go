...
LsaCompactPostParams contains all the parameters to send to the API endpoint
	...
	for the lsa compact post operation.
...
// WithDefaults hydrates default values in the lsa compact post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LsaCompactPostParams) WithDefaults() *LsaCompactPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the lsa compact post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LsaCompactPostParams) SetDefaults() {
