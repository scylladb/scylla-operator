...
MessagingServiceMessagesDroppedByVerGetParams contains all the parameters to send to the API endpoint
	...
	for the messaging service messages dropped by ver get operation.
...
// WithDefaults hydrates default values in the messaging service messages dropped by ver get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MessagingServiceMessagesDroppedByVerGetParams) WithDefaults() *MessagingServiceMessagesDroppedByVerGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the messaging service messages dropped by ver get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MessagingServiceMessagesDroppedByVerGetParams) SetDefaults() {
