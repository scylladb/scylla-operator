...
MessagingServiceMessagesSentGetParams contains all the parameters to send to the API endpoint
	...
	for the messaging service messages sent get operation.
...
// WithDefaults hydrates default values in the messaging service messages sent get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MessagingServiceMessagesSentGetParams) WithDefaults() *MessagingServiceMessagesSentGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the messaging service messages sent get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MessagingServiceMessagesSentGetParams) SetDefaults() {
