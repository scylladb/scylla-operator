...
MessagingServiceVersionGetParams contains all the parameters to send to the API endpoint
	...
	for the messaging service version get operation.
...
// WithDefaults hydrates default values in the messaging service version get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MessagingServiceVersionGetParams) WithDefaults() *MessagingServiceVersionGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the messaging service version get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MessagingServiceVersionGetParams) SetDefaults() {
