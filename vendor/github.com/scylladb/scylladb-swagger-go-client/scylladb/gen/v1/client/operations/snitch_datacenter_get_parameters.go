...
SnitchDatacenterGetParams contains all the parameters to send to the API endpoint
	...
	for the snitch datacenter get operation.
...
// WithDefaults hydrates default values in the snitch datacenter get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SnitchDatacenterGetParams) WithDefaults() *SnitchDatacenterGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the snitch datacenter get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SnitchDatacenterGetParams) SetDefaults() {
