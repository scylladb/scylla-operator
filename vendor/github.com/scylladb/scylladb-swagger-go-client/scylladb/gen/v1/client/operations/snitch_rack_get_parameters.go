...
SnitchRackGetParams contains all the parameters to send to the API endpoint
	...
	for the snitch rack get operation.
...
// WithDefaults hydrates default values in the snitch rack get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SnitchRackGetParams) WithDefaults() *SnitchRackGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the snitch rack get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SnitchRackGetParams) SetDefaults() {
