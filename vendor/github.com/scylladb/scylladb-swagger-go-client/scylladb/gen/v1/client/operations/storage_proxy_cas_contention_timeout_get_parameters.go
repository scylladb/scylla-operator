...
StorageProxyCasContentionTimeoutGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy cas contention timeout get operation.
...
// WithDefaults hydrates default values in the storage proxy cas contention timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyCasContentionTimeoutGetParams) WithDefaults() *StorageProxyCasContentionTimeoutGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy cas contention timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyCasContentionTimeoutGetParams) SetDefaults() {
