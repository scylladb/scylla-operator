...
StorageProxyCounterWriteRPCTimeoutGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy counter write Rpc timeout get operation.
...
// WithDefaults hydrates default values in the storage proxy counter write Rpc timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyCounterWriteRPCTimeoutGetParams) WithDefaults() *StorageProxyCounterWriteRPCTimeoutGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy counter write Rpc timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyCounterWriteRPCTimeoutGetParams) SetDefaults() {
