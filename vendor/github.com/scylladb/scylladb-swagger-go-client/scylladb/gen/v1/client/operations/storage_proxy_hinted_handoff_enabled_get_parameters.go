...
StorageProxyHintedHandoffEnabledGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy hinted handoff enabled get operation.
...
// WithDefaults hydrates default values in the storage proxy hinted handoff enabled get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyHintedHandoffEnabledGetParams) WithDefaults() *StorageProxyHintedHandoffEnabledGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy hinted handoff enabled get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyHintedHandoffEnabledGetParams) SetDefaults() {
