...
StorageProxyHintedHandoffEnabledPostParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy hinted handoff enabled post operation.
...
// WithDefaults hydrates default values in the storage proxy hinted handoff enabled post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyHintedHandoffEnabledPostParams) WithDefaults() *StorageProxyHintedHandoffEnabledPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy hinted handoff enabled post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyHintedHandoffEnabledPostParams) SetDefaults() {
