...
StorageProxyHintsInProgressGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy hints in progress get operation.
...
// WithDefaults hydrates default values in the storage proxy hints in progress get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyHintsInProgressGetParams) WithDefaults() *StorageProxyHintsInProgressGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy hints in progress get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyHintsInProgressGetParams) SetDefaults() {
