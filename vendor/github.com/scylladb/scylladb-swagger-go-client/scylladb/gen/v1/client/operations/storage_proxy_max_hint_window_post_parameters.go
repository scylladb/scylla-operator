...
StorageProxyMaxHintWindowPostParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy max hint window post operation.
...
// WithDefaults hydrates default values in the storage proxy max hint window post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMaxHintWindowPostParams) WithDefaults() *StorageProxyMaxHintWindowPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy max hint window post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMaxHintWindowPostParams) SetDefaults() {
