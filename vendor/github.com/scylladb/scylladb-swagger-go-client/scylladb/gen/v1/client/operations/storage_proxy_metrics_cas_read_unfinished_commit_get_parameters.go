...
StorageProxyMetricsCasReadUnfinishedCommitGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy metrics cas read unfinished commit get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics cas read unfinished commit get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsCasReadUnfinishedCommitGetParams) WithDefaults() *StorageProxyMetricsCasReadUnfinishedCommitGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics cas read unfinished commit get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsCasReadUnfinishedCommitGetParams) SetDefaults() {
