...
func (o *StorageProxyMetricsCasReadUnfinishedCommitGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewStorageProxyMetricsCasReadUnfinishedCommitGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewStorageProxyMetricsCasReadUnfinishedCommitGetDefault(code int) *StorageProxyMetricsCasReadUnfinishedCommitGetDefault {
	return &StorageProxyMetricsCasReadUnfinishedCommitGetDefault{
		_statusCode: code,
	}
}
...
func (o *StorageProxyMetricsCasReadUnfinishedCommitGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
