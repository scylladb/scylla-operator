...
StorageProxyMetricsCasWriteContentionGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy metrics cas write contention get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics cas write contention get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsCasWriteContentionGetParams) WithDefaults() *StorageProxyMetricsCasWriteContentionGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics cas write contention get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsCasWriteContentionGetParams) SetDefaults() {
