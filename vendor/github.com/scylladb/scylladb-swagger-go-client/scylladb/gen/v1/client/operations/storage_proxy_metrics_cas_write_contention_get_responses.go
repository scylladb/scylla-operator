...
func (o *StorageProxyMetricsCasWriteContentionGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewStorageProxyMetricsCasWriteContentionGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewStorageProxyMetricsCasWriteContentionGetDefault(code int) *StorageProxyMetricsCasWriteContentionGetDefault {
	return &StorageProxyMetricsCasWriteContentionGetDefault{
		_statusCode: code,
	}
}
...
func (o *StorageProxyMetricsCasWriteContentionGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
