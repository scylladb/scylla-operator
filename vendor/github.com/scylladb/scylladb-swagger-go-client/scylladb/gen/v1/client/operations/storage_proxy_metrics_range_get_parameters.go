...
StorageProxyMetricsRangeGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy metrics range get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics range get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsRangeGetParams) WithDefaults() *StorageProxyMetricsRangeGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics range get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsRangeGetParams) SetDefaults() {
