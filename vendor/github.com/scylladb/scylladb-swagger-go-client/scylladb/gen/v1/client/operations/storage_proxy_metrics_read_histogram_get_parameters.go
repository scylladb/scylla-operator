...
StorageProxyMetricsReadHistogramGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy metrics read histogram get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics read histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsReadHistogramGetParams) WithDefaults() *StorageProxyMetricsReadHistogramGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics read histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsReadHistogramGetParams) SetDefaults() {
