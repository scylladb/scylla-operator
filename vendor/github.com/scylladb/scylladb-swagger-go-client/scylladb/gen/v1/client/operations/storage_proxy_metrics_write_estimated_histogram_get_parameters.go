...
// NewStorageProxyMetricsWriteEstimatedHistogramGetParams creates a new StorageProxyMetricsWriteEstimatedHistogramGetParams object,
...
// NewStorageProxyMetricsWriteEstimatedHistogramGetParamsWithTimeout creates a new StorageProxyMetricsWriteEstimatedHistogramGetParams object
...
// NewStorageProxyMetricsWriteEstimatedHistogramGetParamsWithContext creates a new StorageProxyMetricsWriteEstimatedHistogramGetParams object
...
// NewStorageProxyMetricsWriteEstimatedHistogramGetParamsWithHTTPClient creates a new StorageProxyMetricsWriteEstimatedHistogramGetParams object
...
/*
StorageProxyMetricsWriteEstimatedHistogramGetParams contains all the parameters to send to the API endpoint

	for the storage proxy metrics write estimated histogram get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics write estimated histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsWriteEstimatedHistogramGetParams) WithDefaults() *StorageProxyMetricsWriteEstimatedHistogramGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics write estimated histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsWriteEstimatedHistogramGetParams) SetDefaults() {
