...
StorageProxyMetricsWriteMovingAverageHistogramGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy metrics write moving average histogram get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics write moving average histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsWriteMovingAverageHistogramGetParams) WithDefaults() *StorageProxyMetricsWriteMovingAverageHistogramGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics write moving average histogram get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsWriteMovingAverageHistogramGetParams) SetDefaults() {
