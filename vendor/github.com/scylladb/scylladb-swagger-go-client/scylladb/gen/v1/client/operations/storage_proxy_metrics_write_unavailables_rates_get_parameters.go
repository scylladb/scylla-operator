...
StorageProxyMetricsWriteUnavailablesRatesGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy metrics write unavailables rates get operation.
...
// WithDefaults hydrates default values in the storage proxy metrics write unavailables rates get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsWriteUnavailablesRatesGetParams) WithDefaults() *StorageProxyMetricsWriteUnavailablesRatesGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy metrics write unavailables rates get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyMetricsWriteUnavailablesRatesGetParams) SetDefaults() {
