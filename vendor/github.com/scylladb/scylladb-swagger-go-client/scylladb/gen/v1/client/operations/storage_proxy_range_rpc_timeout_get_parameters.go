...
StorageProxyRangeRPCTimeoutGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy range Rpc timeout get operation.
...
// WithDefaults hydrates default values in the storage proxy range Rpc timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyRangeRPCTimeoutGetParams) WithDefaults() *StorageProxyRangeRPCTimeoutGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy range Rpc timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyRangeRPCTimeoutGetParams) SetDefaults() {
