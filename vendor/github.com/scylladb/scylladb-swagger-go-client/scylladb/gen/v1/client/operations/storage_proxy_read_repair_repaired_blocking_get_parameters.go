...
StorageProxyReadRepairRepairedBlockingGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy read repair repaired blocking get operation.
...
// WithDefaults hydrates default values in the storage proxy read repair repaired blocking get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyReadRepairRepairedBlockingGetParams) WithDefaults() *StorageProxyReadRepairRepairedBlockingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy read repair repaired blocking get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyReadRepairRepairedBlockingGetParams) SetDefaults() {
