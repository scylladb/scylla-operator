...
// NewStorageProxyReadRPCTimeoutGetParams creates a new StorageProxyReadRPCTimeoutGetParams object,
...
func NewStorageProxyReadRPCTimeoutGetParams() *StorageProxyReadRPCTimeoutGetParams {
	return &StorageProxyReadRPCTimeoutGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStorageProxyReadRPCTimeoutGetParamsWithTimeout creates a new StorageProxyReadRPCTimeoutGetParams object
...
// NewStorageProxyReadRPCTimeoutGetParamsWithContext creates a new StorageProxyReadRPCTimeoutGetParams object
...
// NewStorageProxyReadRPCTimeoutGetParamsWithHTTPClient creates a new StorageProxyReadRPCTimeoutGetParams object
...
/*
StorageProxyReadRPCTimeoutGetParams contains all the parameters to send to the API endpoint

	for the storage proxy read Rpc timeout get operation.
...
// WithDefaults hydrates default values in the storage proxy read Rpc timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyReadRPCTimeoutGetParams) WithDefaults() *StorageProxyReadRPCTimeoutGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy read Rpc timeout get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyReadRPCTimeoutGetParams) SetDefaults() {
