...
StorageProxyReloadTriggerClassesPostParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy reload trigger classes post operation.
...
// WithDefaults hydrates default values in the storage proxy reload trigger classes post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyReloadTriggerClassesPostParams) WithDefaults() *StorageProxyReloadTriggerClassesPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy reload trigger classes post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyReloadTriggerClassesPostParams) SetDefaults() {
