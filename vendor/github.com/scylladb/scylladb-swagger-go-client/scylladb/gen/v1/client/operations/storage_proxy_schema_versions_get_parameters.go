...
StorageProxySchemaVersionsGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy schema versions get operation.
...
// WithDefaults hydrates default values in the storage proxy schema versions get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxySchemaVersionsGetParams) WithDefaults() *StorageProxySchemaVersionsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy schema versions get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxySchemaVersionsGetParams) SetDefaults() {
