...
// NewStorageProxyTotalHintsGetParams creates a new StorageProxyTotalHintsGetParams object,
...
func NewStorageProxyTotalHintsGetParams() *StorageProxyTotalHintsGetParams {
	return &StorageProxyTotalHintsGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStorageProxyTotalHintsGetParamsWithTimeout creates a new StorageProxyTotalHintsGetParams object
...
// NewStorageProxyTotalHintsGetParamsWithContext creates a new StorageProxyTotalHintsGetParams object
...
// NewStorageProxyTotalHintsGetParamsWithHTTPClient creates a new StorageProxyTotalHintsGetParams object
...
StorageProxyTotalHintsGetParams contains all the parameters to send to the API endpoint
	...
	for the storage proxy total hints get operation.
...
// WithDefaults hydrates default values in the storage proxy total hints get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyTotalHintsGetParams) WithDefaults() *StorageProxyTotalHintsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage proxy total hints get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageProxyTotalHintsGetParams) SetDefaults() {
