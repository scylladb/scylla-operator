...
StorageServiceActiveRepairGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service active repair get operation.
...
// WithDefaults hydrates default values in the storage service active repair get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceActiveRepairGetParams) WithDefaults() *StorageServiceActiveRepairGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service active repair get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceActiveRepairGetParams) SetDefaults() {
