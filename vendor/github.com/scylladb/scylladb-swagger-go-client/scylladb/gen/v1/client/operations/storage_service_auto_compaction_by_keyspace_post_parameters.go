...
StorageServiceAutoCompactionByKeyspacePostParams contains all the parameters to send to the API endpoint
	...
	for the storage service auto compaction by keyspace post operation.
...
// WithDefaults hydrates default values in the storage service auto compaction by keyspace post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceAutoCompactionByKeyspacePostParams) WithDefaults() *StorageServiceAutoCompactionByKeyspacePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service auto compaction by keyspace post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceAutoCompactionByKeyspacePostParams) SetDefaults() {
