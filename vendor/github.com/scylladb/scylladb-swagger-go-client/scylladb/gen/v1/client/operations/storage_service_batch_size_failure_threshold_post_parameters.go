...
StorageServiceBatchSizeFailureThresholdPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service batch size failure threshold post operation.
...
// WithDefaults hydrates default values in the storage service batch size failure threshold post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceBatchSizeFailureThresholdPostParams) WithDefaults() *StorageServiceBatchSizeFailureThresholdPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service batch size failure threshold post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceBatchSizeFailureThresholdPostParams) SetDefaults() {
