...
StorageServiceBulkLoadAsyncByPathGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service bulk load async by path get operation.
...
// WithDefaults hydrates default values in the storage service bulk load async by path get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceBulkLoadAsyncByPathGetParams) WithDefaults() *StorageServiceBulkLoadAsyncByPathGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service bulk load async by path get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceBulkLoadAsyncByPathGetParams) SetDefaults() {
