...
StorageServiceBulkLoadByPathPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service bulk load by path post operation.
...
// WithDefaults hydrates default values in the storage service bulk load by path post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceBulkLoadByPathPostParams) WithDefaults() *StorageServiceBulkLoadByPathPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service bulk load by path post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceBulkLoadByPathPostParams) SetDefaults() {
