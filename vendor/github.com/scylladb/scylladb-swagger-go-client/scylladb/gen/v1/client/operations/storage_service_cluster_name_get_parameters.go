...
StorageServiceClusterNameGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service cluster name get operation.
...
// WithDefaults hydrates default values in the storage service cluster name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceClusterNameGetParams) WithDefaults() *StorageServiceClusterNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service cluster name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceClusterNameGetParams) SetDefaults() {
