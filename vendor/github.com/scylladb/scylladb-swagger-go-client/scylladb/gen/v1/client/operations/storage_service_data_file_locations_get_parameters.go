...
StorageServiceDataFileLocationsGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service data file locations get operation.
...
// WithDefaults hydrates default values in the storage service data file locations get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDataFileLocationsGetParams) WithDefaults() *StorageServiceDataFileLocationsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service data file locations get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDataFileLocationsGetParams) SetDefaults() {
