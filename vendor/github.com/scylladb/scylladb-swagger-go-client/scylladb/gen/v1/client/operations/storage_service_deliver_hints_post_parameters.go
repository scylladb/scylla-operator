...
StorageServiceDeliverHintsPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service deliver hints post operation.
...
// WithDefaults hydrates default values in the storage service deliver hints post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDeliverHintsPostParams) WithDefaults() *StorageServiceDeliverHintsPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service deliver hints post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDeliverHintsPostParams) SetDefaults() {
