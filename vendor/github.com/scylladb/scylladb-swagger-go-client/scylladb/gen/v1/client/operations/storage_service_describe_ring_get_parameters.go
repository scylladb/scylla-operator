...
StorageServiceDescribeRingGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service describe ring get operation.
...
// WithDefaults hydrates default values in the storage service describe ring get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDescribeRingGetParams) WithDefaults() *StorageServiceDescribeRingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service describe ring get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDescribeRingGetParams) SetDefaults() {
