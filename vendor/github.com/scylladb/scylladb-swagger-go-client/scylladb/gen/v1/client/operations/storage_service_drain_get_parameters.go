...
StorageServiceDrainGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service drain get operation.
...
// WithDefaults hydrates default values in the storage service drain get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDrainGetParams) WithDefaults() *StorageServiceDrainGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service drain get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceDrainGetParams) SetDefaults() {
