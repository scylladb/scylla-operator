...
StorageServiceForceTerminatePostParams contains all the parameters to send to the API endpoint
	...
	for the storage service force terminate post operation.
...
// WithDefaults hydrates default values in the storage service force terminate post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceForceTerminatePostParams) WithDefaults() *StorageServiceForceTerminatePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service force terminate post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceForceTerminatePostParams) SetDefaults() {
