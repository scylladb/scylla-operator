...
StorageServiceGossipingGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service gossiping get operation.
...
// WithDefaults hydrates default values in the storage service gossiping get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceGossipingGetParams) WithDefaults() *StorageServiceGossipingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service gossiping get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceGossipingGetParams) SetDefaults() {
