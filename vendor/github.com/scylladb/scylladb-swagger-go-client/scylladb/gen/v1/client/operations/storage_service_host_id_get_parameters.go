...
// NewStorageServiceHostIDGetParams creates a new StorageServiceHostIDGetParams object,
...
func NewStorageServiceHostIDGetParams() *StorageServiceHostIDGetParams {
	return &StorageServiceHostIDGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStorageServiceHostIDGetParamsWithTimeout creates a new StorageServiceHostIDGetParams object
...
// NewStorageServiceHostIDGetParamsWithContext creates a new StorageServiceHostIDGetParams object
...
// NewStorageServiceHostIDGetParamsWithHTTPClient creates a new StorageServiceHostIDGetParams object
...
StorageServiceHostIDGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service host Id get operation.
...
// WithDefaults hydrates default values in the storage service host Id get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceHostIDGetParams) WithDefaults() *StorageServiceHostIDGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service host Id get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceHostIDGetParams) SetDefaults() {
