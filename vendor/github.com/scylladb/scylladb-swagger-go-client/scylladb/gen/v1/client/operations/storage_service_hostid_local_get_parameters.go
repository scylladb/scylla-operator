...
StorageServiceHostidLocalGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service hostid local get operation.
...
// WithDefaults hydrates default values in the storage service hostid local get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceHostidLocalGetParams) WithDefaults() *StorageServiceHostidLocalGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service hostid local get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceHostidLocalGetParams) SetDefaults() {
