...
StorageServiceIncrementalBackupsGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service incremental backups get operation.
...
// WithDefaults hydrates default values in the storage service incremental backups get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceIncrementalBackupsGetParams) WithDefaults() *StorageServiceIncrementalBackupsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service incremental backups get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceIncrementalBackupsGetParams) SetDefaults() {
