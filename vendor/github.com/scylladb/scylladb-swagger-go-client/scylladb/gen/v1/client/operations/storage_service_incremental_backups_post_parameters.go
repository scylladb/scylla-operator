...
StorageServiceIncrementalBackupsPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service incremental backups post operation.
...
// WithDefaults hydrates default values in the storage service incremental backups post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceIncrementalBackupsPostParams) WithDefaults() *StorageServiceIncrementalBackupsPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service incremental backups post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceIncrementalBackupsPostParams) SetDefaults() {
