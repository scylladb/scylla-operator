...
StorageServiceIsInitializedGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service is initialized get operation.
...
// WithDefaults hydrates default values in the storage service is initialized get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceIsInitializedGetParams) WithDefaults() *StorageServiceIsInitializedGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service is initialized get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceIsInitializedGetParams) SetDefaults() {
