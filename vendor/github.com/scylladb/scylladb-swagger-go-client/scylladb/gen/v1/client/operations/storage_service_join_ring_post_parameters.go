...
StorageServiceJoinRingPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service join ring post operation.
...
// WithDefaults hydrates default values in the storage service join ring post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceJoinRingPostParams) WithDefaults() *StorageServiceJoinRingPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service join ring post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceJoinRingPostParams) SetDefaults() {
