...
StorageServiceKeyspaceCleanupByKeyspacePostParams contains all the parameters to send to the API endpoint
	...
	for the storage service keyspace cleanup by keyspace post operation.
...
// WithDefaults hydrates default values in the storage service keyspace cleanup by keyspace post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceKeyspaceCleanupByKeyspacePostParams) WithDefaults() *StorageServiceKeyspaceCleanupByKeyspacePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service keyspace cleanup by keyspace post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceKeyspaceCleanupByKeyspacePostParams) SetDefaults() {
