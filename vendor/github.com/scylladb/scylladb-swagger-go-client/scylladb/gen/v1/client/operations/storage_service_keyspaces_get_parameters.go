...
StorageServiceKeyspacesGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service keyspaces get operation.
...
// WithDefaults hydrates default values in the storage service keyspaces get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceKeyspacesGetParams) WithDefaults() *StorageServiceKeyspacesGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service keyspaces get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceKeyspacesGetParams) SetDefaults() {
