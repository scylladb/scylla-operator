...
// NewStorageServiceLoadGetParams creates a new StorageServiceLoadGetParams object,
...
func NewStorageServiceLoadGetParams() *StorageServiceLoadGetParams {
	return &StorageServiceLoadGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStorageServiceLoadGetParamsWithTimeout creates a new StorageServiceLoadGetParams object
...
// NewStorageServiceLoadGetParamsWithContext creates a new StorageServiceLoadGetParams object
...
// NewStorageServiceLoadGetParamsWithHTTPClient creates a new StorageServiceLoadGetParams object
...
/*
StorageServiceLoadGetParams contains all the parameters to send to the API endpoint

	for the storage service load get operation.
...
// WithDefaults hydrates default values in the storage service load get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceLoadGetParams) WithDefaults() *StorageServiceLoadGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service load get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceLoadGetParams) SetDefaults() {
