...
StorageServiceLoadMapGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service load map get operation.
...
// WithDefaults hydrates default values in the storage service load map get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceLoadMapGetParams) WithDefaults() *StorageServiceLoadMapGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service load map get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceLoadMapGetParams) SetDefaults() {
