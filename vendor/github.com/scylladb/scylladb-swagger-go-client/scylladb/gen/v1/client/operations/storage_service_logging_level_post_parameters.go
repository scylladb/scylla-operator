...
StorageServiceLoggingLevelPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service logging level post operation.
...
// WithDefaults hydrates default values in the storage service logging level post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceLoggingLevelPostParams) WithDefaults() *StorageServiceLoggingLevelPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service logging level post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceLoggingLevelPostParams) SetDefaults() {
