...
StorageServiceMetricsLoadGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service metrics load get operation.
...
// WithDefaults hydrates default values in the storage service metrics load get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceMetricsLoadGetParams) WithDefaults() *StorageServiceMetricsLoadGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service metrics load get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceMetricsLoadGetParams) SetDefaults() {
