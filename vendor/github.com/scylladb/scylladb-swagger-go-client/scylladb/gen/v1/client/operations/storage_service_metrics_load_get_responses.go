...
func (o *StorageServiceMetricsLoadGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewStorageServiceMetricsLoadGetOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewStorageServiceMetricsLoadGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewStorageServiceMetricsLoadGetOK() *StorageServiceMetricsLoadGetOK {
	return &StorageServiceMetricsLoadGetOK{}
}
...
func (o *StorageServiceMetricsLoadGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewStorageServiceMetricsLoadGetDefault(code int) *StorageServiceMetricsLoadGetDefault {
	return &StorageServiceMetricsLoadGetDefault{
		_statusCode: code,
	}
}
...
func (o *StorageServiceMetricsLoadGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
