...
StorageServiceNaturalEndpointsByKeyspaceGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service natural endpoints by keyspace get operation.
...
// WithDefaults hydrates default values in the storage service natural endpoints by keyspace get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNaturalEndpointsByKeyspaceGetParams) WithDefaults() *StorageServiceNaturalEndpointsByKeyspaceGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service natural endpoints by keyspace get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNaturalEndpointsByKeyspaceGetParams) SetDefaults() {
