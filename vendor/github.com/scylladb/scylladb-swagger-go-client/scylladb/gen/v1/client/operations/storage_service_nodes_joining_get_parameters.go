...
StorageServiceNodesJoiningGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service nodes joining get operation.
...
// WithDefaults hydrates default values in the storage service nodes joining get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNodesJoiningGetParams) WithDefaults() *StorageServiceNodesJoiningGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service nodes joining get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNodesJoiningGetParams) SetDefaults() {
