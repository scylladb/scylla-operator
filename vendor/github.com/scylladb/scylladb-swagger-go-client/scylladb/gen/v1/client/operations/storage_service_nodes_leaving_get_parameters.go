...
StorageServiceNodesLeavingGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service nodes leaving get operation.
...
// WithDefaults hydrates default values in the storage service nodes leaving get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNodesLeavingGetParams) WithDefaults() *StorageServiceNodesLeavingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service nodes leaving get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNodesLeavingGetParams) SetDefaults() {
