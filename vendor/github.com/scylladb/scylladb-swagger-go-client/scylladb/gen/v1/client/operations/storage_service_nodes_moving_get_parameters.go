...
// NewStorageServiceNodesMovingGetParams creates a new StorageServiceNodesMovingGetParams object,
...
func NewStorageServiceNodesMovingGetParams() *StorageServiceNodesMovingGetParams {
	return &StorageServiceNodesMovingGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewStorageServiceNodesMovingGetParamsWithTimeout creates a new StorageServiceNodesMovingGetParams object
...
// NewStorageServiceNodesMovingGetParamsWithContext creates a new StorageServiceNodesMovingGetParams object
...
// NewStorageServiceNodesMovingGetParamsWithHTTPClient creates a new StorageServiceNodesMovingGetParams object
...
StorageServiceNodesMovingGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service nodes moving get operation.
...
// WithDefaults hydrates default values in the storage service nodes moving get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNodesMovingGetParams) WithDefaults() *StorageServiceNodesMovingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service nodes moving get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceNodesMovingGetParams) SetDefaults() {
