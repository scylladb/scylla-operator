...
StorageServiceOperationModeGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service operation mode get operation.
...
// WithDefaults hydrates default values in the storage service operation mode get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceOperationModeGetParams) WithDefaults() *StorageServiceOperationModeGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service operation mode get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceOperationModeGetParams) SetDefaults() {
