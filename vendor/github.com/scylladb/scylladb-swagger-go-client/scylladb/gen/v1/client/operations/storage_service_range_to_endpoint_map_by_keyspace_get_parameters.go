...
StorageServiceRangeToEndpointMapByKeyspaceGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service range to endpoint map by keyspace get operation.
...
// WithDefaults hydrates default values in the storage service range to endpoint map by keyspace get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRangeToEndpointMapByKeyspaceGetParams) WithDefaults() *StorageServiceRangeToEndpointMapByKeyspaceGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service range to endpoint map by keyspace get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRangeToEndpointMapByKeyspaceGetParams) SetDefaults() {
