...
StorageServiceRebuildPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service rebuild post operation.
...
// WithDefaults hydrates default values in the storage service rebuild post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRebuildPostParams) WithDefaults() *StorageServiceRebuildPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service rebuild post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRebuildPostParams) SetDefaults() {
