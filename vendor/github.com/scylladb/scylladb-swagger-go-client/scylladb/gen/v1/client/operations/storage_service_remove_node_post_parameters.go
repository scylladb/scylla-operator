...
StorageServiceRemoveNodePostParams contains all the parameters to send to the API endpoint
	...
	for the storage service remove node post operation.
...
// WithDefaults hydrates default values in the storage service remove node post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRemoveNodePostParams) WithDefaults() *StorageServiceRemoveNodePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service remove node post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRemoveNodePostParams) SetDefaults() {
