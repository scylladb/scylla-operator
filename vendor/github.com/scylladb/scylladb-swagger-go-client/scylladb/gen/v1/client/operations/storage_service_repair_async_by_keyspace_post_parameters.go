...
StorageServiceRepairAsyncByKeyspacePostParams contains all the parameters to send to the API endpoint
	...
	for the storage service repair async by keyspace post operation.
...
// WithDefaults hydrates default values in the storage service repair async by keyspace post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRepairAsyncByKeyspacePostParams) WithDefaults() *StorageServiceRepairAsyncByKeyspacePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service repair async by keyspace post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRepairAsyncByKeyspacePostParams) SetDefaults() {
