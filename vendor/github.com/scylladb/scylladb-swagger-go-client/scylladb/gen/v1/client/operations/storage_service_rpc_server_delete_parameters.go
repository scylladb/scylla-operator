...
// NewStorageServiceRPCServerDeleteParams creates a new StorageServiceRPCServerDeleteParams object,
...
// NewStorageServiceRPCServerDeleteParamsWithTimeout creates a new StorageServiceRPCServerDeleteParams object
...
// NewStorageServiceRPCServerDeleteParamsWithContext creates a new StorageServiceRPCServerDeleteParams object
...
// NewStorageServiceRPCServerDeleteParamsWithHTTPClient creates a new StorageServiceRPCServerDeleteParams object
...
StorageServiceRPCServerDeleteParams contains all the parameters to send to the API endpoint
	...
	for the storage service Rpc server delete operation.
...
// WithDefaults hydrates default values in the storage service Rpc server delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRPCServerDeleteParams) WithDefaults() *StorageServiceRPCServerDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service Rpc server delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRPCServerDeleteParams) SetDefaults() {
