...
StorageServiceRPCServerGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service Rpc server get operation.
...
// WithDefaults hydrates default values in the storage service Rpc server get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRPCServerGetParams) WithDefaults() *StorageServiceRPCServerGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service Rpc server get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceRPCServerGetParams) SetDefaults() {
