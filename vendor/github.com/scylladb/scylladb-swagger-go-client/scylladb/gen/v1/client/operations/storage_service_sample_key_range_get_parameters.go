...
StorageServiceSampleKeyRangeGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service sample key range get operation.
...
// WithDefaults hydrates default values in the storage service sample key range get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSampleKeyRangeGetParams) WithDefaults() *StorageServiceSampleKeyRangeGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service sample key range get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSampleKeyRangeGetParams) SetDefaults() {
