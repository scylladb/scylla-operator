...
StorageServiceSavedCachesLocationGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service saved caches location get operation.
...
// WithDefaults hydrates default values in the storage service saved caches location get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSavedCachesLocationGetParams) WithDefaults() *StorageServiceSavedCachesLocationGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service saved caches location get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSavedCachesLocationGetParams) SetDefaults() {
