...
StorageServiceSchemaVersionGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service schema version get operation.
...
// WithDefaults hydrates default values in the storage service schema version get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSchemaVersionGetParams) WithDefaults() *StorageServiceSchemaVersionGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service schema version get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSchemaVersionGetParams) SetDefaults() {
