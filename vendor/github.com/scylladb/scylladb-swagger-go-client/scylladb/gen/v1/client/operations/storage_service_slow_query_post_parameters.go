...
StorageServiceSlowQueryPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service slow query post operation.
...
// WithDefaults hydrates default values in the storage service slow query post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSlowQueryPostParams) WithDefaults() *StorageServiceSlowQueryPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service slow query post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSlowQueryPostParams) SetDefaults() {
