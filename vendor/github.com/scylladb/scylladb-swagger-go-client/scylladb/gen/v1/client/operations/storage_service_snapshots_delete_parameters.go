...
StorageServiceSnapshotsDeleteParams contains all the parameters to send to the API endpoint
	...
	for the storage service snapshots delete operation.
...
// WithDefaults hydrates default values in the storage service snapshots delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSnapshotsDeleteParams) WithDefaults() *StorageServiceSnapshotsDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service snapshots delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSnapshotsDeleteParams) SetDefaults() {
