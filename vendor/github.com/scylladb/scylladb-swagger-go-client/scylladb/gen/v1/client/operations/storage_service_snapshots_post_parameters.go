...
StorageServiceSnapshotsPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service snapshots post operation.
...
// WithDefaults hydrates default values in the storage service snapshots post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSnapshotsPostParams) WithDefaults() *StorageServiceSnapshotsPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service snapshots post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSnapshotsPostParams) SetDefaults() {
