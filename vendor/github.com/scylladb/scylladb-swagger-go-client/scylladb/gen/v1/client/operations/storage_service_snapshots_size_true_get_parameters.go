...
StorageServiceSnapshotsSizeTrueGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service snapshots size true get operation.
...
// WithDefaults hydrates default values in the storage service snapshots size true get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSnapshotsSizeTrueGetParams) WithDefaults() *StorageServiceSnapshotsSizeTrueGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service snapshots size true get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceSnapshotsSizeTrueGetParams) SetDefaults() {
