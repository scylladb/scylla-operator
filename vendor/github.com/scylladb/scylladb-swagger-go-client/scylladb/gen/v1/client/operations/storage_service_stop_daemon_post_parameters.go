...
StorageServiceStopDaemonPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service stop daemon post operation.
...
// WithDefaults hydrates default values in the storage service stop daemon post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceStopDaemonPostParams) WithDefaults() *StorageServiceStopDaemonPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service stop daemon post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceStopDaemonPostParams) SetDefaults() {
