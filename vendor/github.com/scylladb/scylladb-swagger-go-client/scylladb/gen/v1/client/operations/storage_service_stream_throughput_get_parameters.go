...
StorageServiceStreamThroughputGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service stream throughput get operation.
...
// WithDefaults hydrates default values in the storage service stream throughput get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceStreamThroughputGetParams) WithDefaults() *StorageServiceStreamThroughputGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service stream throughput get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceStreamThroughputGetParams) SetDefaults() {
