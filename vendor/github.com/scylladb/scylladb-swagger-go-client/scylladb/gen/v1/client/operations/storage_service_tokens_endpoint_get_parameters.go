...
StorageServiceTokensEndpointGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service tokens endpoint get operation.
...
// WithDefaults hydrates default values in the storage service tokens endpoint get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTokensEndpointGetParams) WithDefaults() *StorageServiceTokensEndpointGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service tokens endpoint get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTokensEndpointGetParams) SetDefaults() {
