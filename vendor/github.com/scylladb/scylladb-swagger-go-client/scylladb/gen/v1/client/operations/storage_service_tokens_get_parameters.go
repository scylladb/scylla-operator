...
StorageServiceTokensGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service tokens get operation.
...
// WithDefaults hydrates default values in the storage service tokens get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTokensGetParams) WithDefaults() *StorageServiceTokensGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service tokens get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTokensGetParams) SetDefaults() {
