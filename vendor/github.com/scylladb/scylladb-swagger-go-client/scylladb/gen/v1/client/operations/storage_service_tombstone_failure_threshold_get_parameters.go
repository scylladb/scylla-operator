...
StorageServiceTombstoneFailureThresholdGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service tombstone failure threshold get operation.
...
// WithDefaults hydrates default values in the storage service tombstone failure threshold get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTombstoneFailureThresholdGetParams) WithDefaults() *StorageServiceTombstoneFailureThresholdGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service tombstone failure threshold get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTombstoneFailureThresholdGetParams) SetDefaults() {
