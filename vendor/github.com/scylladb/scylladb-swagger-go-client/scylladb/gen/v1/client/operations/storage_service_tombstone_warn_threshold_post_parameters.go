...
StorageServiceTombstoneWarnThresholdPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service tombstone warn threshold post operation.
...
// WithDefaults hydrates default values in the storage service tombstone warn threshold post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTombstoneWarnThresholdPostParams) WithDefaults() *StorageServiceTombstoneWarnThresholdPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service tombstone warn threshold post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTombstoneWarnThresholdPostParams) SetDefaults() {
