...
StorageServiceTraceProbabilityGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service trace probability get operation.
...
// WithDefaults hydrates default values in the storage service trace probability get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTraceProbabilityGetParams) WithDefaults() *StorageServiceTraceProbabilityGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service trace probability get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceTraceProbabilityGetParams) SetDefaults() {
