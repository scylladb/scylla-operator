...
StorageServiceUpdateSnitchPostParams contains all the parameters to send to the API endpoint
	...
	for the storage service update snitch post operation.
...
// WithDefaults hydrates default values in the storage service update snitch post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceUpdateSnitchPostParams) WithDefaults() *StorageServiceUpdateSnitchPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service update snitch post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceUpdateSnitchPostParams) SetDefaults() {
