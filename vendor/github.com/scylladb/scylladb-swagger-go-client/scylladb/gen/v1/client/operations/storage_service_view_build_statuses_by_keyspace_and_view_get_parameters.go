...
StorageServiceViewBuildStatusesByKeyspaceAndViewGetParams contains all the parameters to send to the API endpoint
	...
	for the storage service view build statuses by keyspace and view get operation.
...
// WithDefaults hydrates default values in the storage service view build statuses by keyspace and view get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceViewBuildStatusesByKeyspaceAndViewGetParams) WithDefaults() *StorageServiceViewBuildStatusesByKeyspaceAndViewGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the storage service view build statuses by keyspace and view get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StorageServiceViewBuildStatusesByKeyspaceAndViewGetParams) SetDefaults() {
