...
StreamManagerMetricsIncomingByPeerGetParams contains all the parameters to send to the API endpoint
	...
	for the stream manager metrics incoming by peer get operation.
...
// WithDefaults hydrates default values in the stream manager metrics incoming by peer get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StreamManagerMetricsIncomingByPeerGetParams) WithDefaults() *StreamManagerMetricsIncomingByPeerGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the stream manager metrics incoming by peer get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StreamManagerMetricsIncomingByPeerGetParams) SetDefaults() {
