...
StreamManagerMetricsIncomingGetParams contains all the parameters to send to the API endpoint
	...
	for the stream manager metrics incoming get operation.
...
// WithDefaults hydrates default values in the stream manager metrics incoming get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StreamManagerMetricsIncomingGetParams) WithDefaults() *StreamManagerMetricsIncomingGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the stream manager metrics incoming get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StreamManagerMetricsIncomingGetParams) SetDefaults() {
