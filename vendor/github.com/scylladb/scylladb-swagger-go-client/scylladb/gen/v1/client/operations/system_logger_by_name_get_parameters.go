...
// NewSystemLoggerByNameGetParams creates a new SystemLoggerByNameGetParams object,
...
func NewSystemLoggerByNameGetParams() *SystemLoggerByNameGetParams {
	return &SystemLoggerByNameGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewSystemLoggerByNameGetParamsWithTimeout creates a new SystemLoggerByNameGetParams object
...
// NewSystemLoggerByNameGetParamsWithContext creates a new SystemLoggerByNameGetParams object
...
// NewSystemLoggerByNameGetParamsWithHTTPClient creates a new SystemLoggerByNameGetParams object
...
/*
SystemLoggerByNameGetParams contains all the parameters to send to the API endpoint

	for the system logger by name get operation.
...
// WithDefaults hydrates default values in the system logger by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemLoggerByNameGetParams) WithDefaults() *SystemLoggerByNameGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the system logger by name get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemLoggerByNameGetParams) SetDefaults() {
