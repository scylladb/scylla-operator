...
SystemLoggerGetParams contains all the parameters to send to the API endpoint
	...
	for the system logger get operation.
...
// WithDefaults hydrates default values in the system logger get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemLoggerGetParams) WithDefaults() *SystemLoggerGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the system logger get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemLoggerGetParams) SetDefaults() {
