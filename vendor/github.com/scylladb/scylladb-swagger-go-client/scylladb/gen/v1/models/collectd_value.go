...
// ContextValidate validates this collectd value based on context it is used
func (m *CollectdValue) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
