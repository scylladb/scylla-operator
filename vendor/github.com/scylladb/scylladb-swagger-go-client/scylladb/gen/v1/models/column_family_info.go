...
// ContextValidate validates this column family info based on context it is used
func (m *ColumnFamilyInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
