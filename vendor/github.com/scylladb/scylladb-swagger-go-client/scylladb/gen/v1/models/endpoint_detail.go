...
// ContextValidate validates this endpoint detail based on context it is used
func (m *EndpointDetail) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
