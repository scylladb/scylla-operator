...
// ContextValidate validates this endpoint phi value based on context it is used
func (m *EndpointPhiValue) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
