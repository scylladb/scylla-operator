...
// ContextValidate validates this estimated histogram based on context it is used
func (m *EstimatedHistogram) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
