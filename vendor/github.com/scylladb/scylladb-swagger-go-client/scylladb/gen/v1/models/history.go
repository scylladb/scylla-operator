		...
		if m.RowsMerged[i] != nil {
			if err := m.RowsMerged[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("rows_merged" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *History) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRowsMerged(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *History) contextValidateRowsMerged(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.RowsMerged); i++ {
		...
		if m.RowsMerged[i] != nil {
			...
			if err := m.RowsMerged[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("rows_merged" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("rows_merged" + "." + strconv.Itoa(i))
