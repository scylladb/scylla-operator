...
// ContextValidate validates this map string double based on context it is used
func (m *MapStringDouble) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
