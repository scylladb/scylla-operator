...
// ContextValidate validates this message counter based on context it is used
func (m *MessageCounter) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
