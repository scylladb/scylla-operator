...
// ContextValidate validate this progress info mapper based on the context it is used
func (m *ProgressInfoMapper) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ProgressInfoMapper) contextValidateValue(ctx context.Context, formats strfmt.Registry) error {
