...
// ContextValidate validates this rate moving average based on context it is used
func (m *RateMovingAverage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
