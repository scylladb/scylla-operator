...
// ContextValidate validates this row merged based on context it is used
func (m *RowMerged) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
