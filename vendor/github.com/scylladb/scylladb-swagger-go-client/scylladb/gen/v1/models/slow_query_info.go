...
// ContextValidate validates this slow query info based on context it is used
func (m *SlowQueryInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
