...
// ContextValidate validates this stream summary based on context it is used
func (m *StreamSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
