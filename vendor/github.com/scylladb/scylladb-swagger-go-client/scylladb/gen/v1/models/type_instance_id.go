...
// ContextValidate validates this type instance id based on context it is used
func (m *TypeInstanceID) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
