...
FindConfigAPIDocDirParams contains all the parameters to send to the API endpoint
	...
	for the find config api doc dir operation.
...
// WithDefaults hydrates default values in the find config api doc dir params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigAPIDocDirParams) WithDefaults() *FindConfigAPIDocDirParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config api doc dir params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigAPIDocDirParams) SetDefaults() {
