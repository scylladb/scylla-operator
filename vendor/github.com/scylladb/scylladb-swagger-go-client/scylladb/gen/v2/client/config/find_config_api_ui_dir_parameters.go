...
FindConfigAPIUIDirParams contains all the parameters to send to the API endpoint
	...
	for the find config api ui dir operation.
...
// WithDefaults hydrates default values in the find config api ui dir params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigAPIUIDirParams) WithDefaults() *FindConfigAPIUIDirParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config api ui dir params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigAPIUIDirParams) SetDefaults() {
