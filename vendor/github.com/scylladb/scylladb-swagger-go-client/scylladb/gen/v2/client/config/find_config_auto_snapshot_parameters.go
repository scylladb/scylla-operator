...
FindConfigAutoSnapshotParams contains all the parameters to send to the API endpoint
	...
	for the find config auto snapshot operation.
...
// WithDefaults hydrates default values in the find config auto snapshot params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigAutoSnapshotParams) WithDefaults() *FindConfigAutoSnapshotParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config auto snapshot params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigAutoSnapshotParams) SetDefaults() {
