...
FindConfigBatchSizeFailThresholdInKbParams contains all the parameters to send to the API endpoint
	...
	for the find config batch size fail threshold in kb operation.
...
// WithDefaults hydrates default values in the find config batch size fail threshold in kb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigBatchSizeFailThresholdInKbParams) WithDefaults() *FindConfigBatchSizeFailThresholdInKbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config batch size fail threshold in kb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigBatchSizeFailThresholdInKbParams) SetDefaults() {
