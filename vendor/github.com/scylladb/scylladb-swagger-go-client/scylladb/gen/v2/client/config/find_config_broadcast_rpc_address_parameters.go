...
FindConfigBroadcastRPCAddressParams contains all the parameters to send to the API endpoint
	...
	for the find config broadcast rpc address operation.
...
// WithDefaults hydrates default values in the find config broadcast rpc address params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigBroadcastRPCAddressParams) WithDefaults() *FindConfigBroadcastRPCAddressParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config broadcast rpc address params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigBroadcastRPCAddressParams) SetDefaults() {
