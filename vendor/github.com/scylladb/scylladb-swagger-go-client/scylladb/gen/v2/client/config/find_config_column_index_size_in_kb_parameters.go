...
FindConfigColumnIndexSizeInKbParams contains all the parameters to send to the API endpoint
	...
	for the find config column index size in kb operation.
...
// WithDefaults hydrates default values in the find config column index size in kb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigColumnIndexSizeInKbParams) WithDefaults() *FindConfigColumnIndexSizeInKbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config column index size in kb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigColumnIndexSizeInKbParams) SetDefaults() {
