...
FindConfigCommitlogReuseSegmentsParams contains all the parameters to send to the API endpoint
	...
	for the find config commitlog reuse segments operation.
...
// WithDefaults hydrates default values in the find config commitlog reuse segments params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogReuseSegmentsParams) WithDefaults() *FindConfigCommitlogReuseSegmentsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config commitlog reuse segments params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogReuseSegmentsParams) SetDefaults() {
