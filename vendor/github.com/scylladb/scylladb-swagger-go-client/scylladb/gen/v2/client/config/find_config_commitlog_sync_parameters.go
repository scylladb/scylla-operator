...
FindConfigCommitlogSyncParams contains all the parameters to send to the API endpoint
	...
	for the find config commitlog sync operation.
...
// WithDefaults hydrates default values in the find config commitlog sync params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogSyncParams) WithDefaults() *FindConfigCommitlogSyncParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config commitlog sync params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogSyncParams) SetDefaults() {
