...
FindConfigCommitlogTotalSpaceInMbParams contains all the parameters to send to the API endpoint
	...
	for the find config commitlog total space in mb operation.
...
// WithDefaults hydrates default values in the find config commitlog total space in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogTotalSpaceInMbParams) WithDefaults() *FindConfigCommitlogTotalSpaceInMbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config commitlog total space in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogTotalSpaceInMbParams) SetDefaults() {
