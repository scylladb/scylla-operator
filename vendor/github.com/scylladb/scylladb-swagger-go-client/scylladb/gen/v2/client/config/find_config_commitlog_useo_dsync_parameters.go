...
FindConfigCommitlogUseoDsyncParams contains all the parameters to send to the API endpoint
	...
	for the find config commitlog use o dsync operation.
...
// WithDefaults hydrates default values in the find config commitlog use o dsync params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogUseoDsyncParams) WithDefaults() *FindConfigCommitlogUseoDsyncParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config commitlog use o dsync params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCommitlogUseoDsyncParams) SetDefaults() {
