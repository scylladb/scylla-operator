...
FindConfigCompactionLargeRowWarningThresholdMbParams contains all the parameters to send to the API endpoint
	...
	for the find config compaction large row warning threshold mb operation.
...
// WithDefaults hydrates default values in the find config compaction large row warning threshold mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCompactionLargeRowWarningThresholdMbParams) WithDefaults() *FindConfigCompactionLargeRowWarningThresholdMbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config compaction large row warning threshold mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCompactionLargeRowWarningThresholdMbParams) SetDefaults() {
