...
FindConfigCounterCacheKeysToSaveParams contains all the parameters to send to the API endpoint
	...
	for the find config counter cache keys to save operation.
...
// WithDefaults hydrates default values in the find config counter cache keys to save params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCounterCacheKeysToSaveParams) WithDefaults() *FindConfigCounterCacheKeysToSaveParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config counter cache keys to save params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigCounterCacheKeysToSaveParams) SetDefaults() {
