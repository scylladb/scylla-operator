...
FindConfigEnableCommitlogParams contains all the parameters to send to the API endpoint
	...
	for the find config enable commitlog operation.
...
// WithDefaults hydrates default values in the find config enable commitlog params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigEnableCommitlogParams) WithDefaults() *FindConfigEnableCommitlogParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config enable commitlog params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigEnableCommitlogParams) SetDefaults() {
