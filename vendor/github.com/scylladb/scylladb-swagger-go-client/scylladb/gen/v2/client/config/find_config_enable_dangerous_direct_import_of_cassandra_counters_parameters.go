...
FindConfigEnableDangerousDirectImportOfCassandraCountersParams contains all the parameters to send to the API endpoint
	...
	for the find config enable dangerous direct import of cassandra counters operation.
...
// WithDefaults hydrates default values in the find config enable dangerous direct import of cassandra counters params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigEnableDangerousDirectImportOfCassandraCountersParams) WithDefaults() *FindConfigEnableDangerousDirectImportOfCassandraCountersParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config enable dangerous direct import of cassandra counters params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigEnableDangerousDirectImportOfCassandraCountersParams) SetDefaults() {
