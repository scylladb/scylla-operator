...
FindConfigEnableSstablesMcFormatParams contains all the parameters to send to the API endpoint
	...
	for the find config enable sstables mc format operation.
...
// WithDefaults hydrates default values in the find config enable sstables mc format params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigEnableSstablesMcFormatParams) WithDefaults() *FindConfigEnableSstablesMcFormatParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config enable sstables mc format params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigEnableSstablesMcFormatParams) SetDefaults() {
