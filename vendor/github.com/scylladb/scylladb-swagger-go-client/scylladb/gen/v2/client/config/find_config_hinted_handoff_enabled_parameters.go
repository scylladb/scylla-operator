...
FindConfigHintedHandoffEnabledParams contains all the parameters to send to the API endpoint
	...
	for the find config hinted handoff enabled operation.
...
// WithDefaults hydrates default values in the find config hinted handoff enabled params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigHintedHandoffEnabledParams) WithDefaults() *FindConfigHintedHandoffEnabledParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config hinted handoff enabled params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigHintedHandoffEnabledParams) SetDefaults() {
