...
FindConfigHintsDirectoryParams contains all the parameters to send to the API endpoint
	...
	for the find config hints directory operation.
...
// WithDefaults hydrates default values in the find config hints directory params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigHintsDirectoryParams) WithDefaults() *FindConfigHintsDirectoryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config hints directory params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigHintsDirectoryParams) SetDefaults() {
