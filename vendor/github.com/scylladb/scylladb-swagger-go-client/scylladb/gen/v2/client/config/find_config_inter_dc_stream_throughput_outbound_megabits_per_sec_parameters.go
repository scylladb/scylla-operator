...
FindConfigInterDcStreamThroughputOutboundMegabitsPerSecParams contains all the parameters to send to the API endpoint
	...
	for the find config inter dc stream throughput outbound megabits per sec operation.
...
// WithDefaults hydrates default values in the find config inter dc stream throughput outbound megabits per sec params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInterDcStreamThroughputOutboundMegabitsPerSecParams) WithDefaults() *FindConfigInterDcStreamThroughputOutboundMegabitsPerSecParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config inter dc stream throughput outbound megabits per sec params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInterDcStreamThroughputOutboundMegabitsPerSecParams) SetDefaults() {
