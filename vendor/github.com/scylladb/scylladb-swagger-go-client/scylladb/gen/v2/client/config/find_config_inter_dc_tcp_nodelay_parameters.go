...
FindConfigInterDcTCPNodelayParams contains all the parameters to send to the API endpoint
	...
	for the find config inter dc tcp nodelay operation.
...
// WithDefaults hydrates default values in the find config inter dc tcp nodelay params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInterDcTCPNodelayParams) WithDefaults() *FindConfigInterDcTCPNodelayParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config inter dc tcp nodelay params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInterDcTCPNodelayParams) SetDefaults() {
