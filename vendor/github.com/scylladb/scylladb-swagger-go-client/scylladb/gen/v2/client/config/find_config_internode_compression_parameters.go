...
FindConfigInternodeCompressionParams contains all the parameters to send to the API endpoint
	...
	for the find config internode compression operation.
...
// WithDefaults hydrates default values in the find config internode compression params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInternodeCompressionParams) WithDefaults() *FindConfigInternodeCompressionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config internode compression params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInternodeCompressionParams) SetDefaults() {
