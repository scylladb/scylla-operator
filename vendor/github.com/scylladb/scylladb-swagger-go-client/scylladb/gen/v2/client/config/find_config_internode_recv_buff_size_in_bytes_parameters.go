...
FindConfigInternodeRecvBuffSizeInBytesParams contains all the parameters to send to the API endpoint
	...
	for the find config internode recv buff size in bytes operation.
...
// WithDefaults hydrates default values in the find config internode recv buff size in bytes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInternodeRecvBuffSizeInBytesParams) WithDefaults() *FindConfigInternodeRecvBuffSizeInBytesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config internode recv buff size in bytes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigInternodeRecvBuffSizeInBytesParams) SetDefaults() {
