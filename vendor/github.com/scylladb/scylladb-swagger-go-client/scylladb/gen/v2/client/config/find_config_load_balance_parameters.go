...
FindConfigLoadBalanceParams contains all the parameters to send to the API endpoint
	...
	for the find config load balance operation.
...
// WithDefaults hydrates default values in the find config load balance params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigLoadBalanceParams) WithDefaults() *FindConfigLoadBalanceParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config load balance params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigLoadBalanceParams) SetDefaults() {
