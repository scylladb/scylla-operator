...
FindConfigLoadRingStateParams contains all the parameters to send to the API endpoint
	...
	for the find config load ring state operation.
...
// WithDefaults hydrates default values in the find config load ring state params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigLoadRingStateParams) WithDefaults() *FindConfigLoadRingStateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config load ring state params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigLoadRingStateParams) SetDefaults() {
