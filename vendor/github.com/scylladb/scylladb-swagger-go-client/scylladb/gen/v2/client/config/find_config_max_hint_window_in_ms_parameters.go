...
FindConfigMaxHintWindowInMsParams contains all the parameters to send to the API endpoint
	...
	for the find config max hint window in ms operation.
...
// WithDefaults hydrates default values in the find config max hint window in ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMaxHintWindowInMsParams) WithDefaults() *FindConfigMaxHintWindowInMsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config max hint window in ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMaxHintWindowInMsParams) SetDefaults() {
