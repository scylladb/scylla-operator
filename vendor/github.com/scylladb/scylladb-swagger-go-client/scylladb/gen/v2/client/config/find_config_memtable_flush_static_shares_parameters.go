...
FindConfigMemtableFlushStaticSharesParams contains all the parameters to send to the API endpoint
	...
	for the find config memtable flush static shares operation.
...
// WithDefaults hydrates default values in the find config memtable flush static shares params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMemtableFlushStaticSharesParams) WithDefaults() *FindConfigMemtableFlushStaticSharesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config memtable flush static shares params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMemtableFlushStaticSharesParams) SetDefaults() {
