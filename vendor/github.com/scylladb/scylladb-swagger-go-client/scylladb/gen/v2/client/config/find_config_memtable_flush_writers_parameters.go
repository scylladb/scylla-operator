...
FindConfigMemtableFlushWritersParams contains all the parameters to send to the API endpoint
	...
	for the find config memtable flush writers operation.
...
// WithDefaults hydrates default values in the find config memtable flush writers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMemtableFlushWritersParams) WithDefaults() *FindConfigMemtableFlushWritersParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config memtable flush writers params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMemtableFlushWritersParams) SetDefaults() {
