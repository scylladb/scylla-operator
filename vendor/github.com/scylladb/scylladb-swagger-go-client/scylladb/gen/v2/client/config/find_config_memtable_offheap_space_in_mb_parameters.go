...
FindConfigMemtableOffheapSpaceInMbParams contains all the parameters to send to the API endpoint
	...
	for the find config memtable offheap space in mb operation.
...
// WithDefaults hydrates default values in the find config memtable offheap space in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMemtableOffheapSpaceInMbParams) WithDefaults() *FindConfigMemtableOffheapSpaceInMbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config memtable offheap space in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMemtableOffheapSpaceInMbParams) SetDefaults() {
