...
FindConfigMurmur3PartitionerIgnoreMsbBitsParams contains all the parameters to send to the API endpoint
	...
	for the find config murmur3 partitioner ignore msb bits operation.
...
// WithDefaults hydrates default values in the find config murmur3 partitioner ignore msb bits params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMurmur3PartitionerIgnoreMsbBitsParams) WithDefaults() *FindConfigMurmur3PartitionerIgnoreMsbBitsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config murmur3 partitioner ignore msb bits params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigMurmur3PartitionerIgnoreMsbBitsParams) SetDefaults() {
