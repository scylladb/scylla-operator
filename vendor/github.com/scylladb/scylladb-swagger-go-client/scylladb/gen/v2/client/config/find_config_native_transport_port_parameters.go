...
FindConfigNativeTransportPortParams contains all the parameters to send to the API endpoint
	...
	for the find config native transport port operation.
...
// WithDefaults hydrates default values in the find config native transport port params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigNativeTransportPortParams) WithDefaults() *FindConfigNativeTransportPortParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config native transport port params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigNativeTransportPortParams) SetDefaults() {
