...
FindConfigNumTokensParams contains all the parameters to send to the API endpoint
	...
	for the find config num tokens operation.
...
// WithDefaults hydrates default values in the find config num tokens params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigNumTokensParams) WithDefaults() *FindConfigNumTokensParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config num tokens params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigNumTokensParams) SetDefaults() {
