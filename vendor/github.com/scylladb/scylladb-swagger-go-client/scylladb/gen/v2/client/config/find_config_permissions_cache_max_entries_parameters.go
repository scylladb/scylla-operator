...
FindConfigPermissionsCacheMaxEntriesParams contains all the parameters to send to the API endpoint
	...
	for the find config permissions cache max entries operation.
...
// WithDefaults hydrates default values in the find config permissions cache max entries params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigPermissionsCacheMaxEntriesParams) WithDefaults() *FindConfigPermissionsCacheMaxEntriesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config permissions cache max entries params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigPermissionsCacheMaxEntriesParams) SetDefaults() {
