...
FindConfigReduceCacheCapacityToParams contains all the parameters to send to the API endpoint
	...
	for the find config reduce cache capacity to operation.
...
// WithDefaults hydrates default values in the find config reduce cache capacity to params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigReduceCacheCapacityToParams) WithDefaults() *FindConfigReduceCacheCapacityToParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config reduce cache capacity to params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigReduceCacheCapacityToParams) SetDefaults() {
