...
FindConfigReplaceAddressFirstBootParams contains all the parameters to send to the API endpoint
	...
	for the find config replace address first boot operation.
...
// WithDefaults hydrates default values in the find config replace address first boot params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigReplaceAddressFirstBootParams) WithDefaults() *FindConfigReplaceAddressFirstBootParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config replace address first boot params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigReplaceAddressFirstBootParams) SetDefaults() {
