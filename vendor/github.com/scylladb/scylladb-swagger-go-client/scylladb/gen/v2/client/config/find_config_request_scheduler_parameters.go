...
FindConfigRequestSchedulerParams contains all the parameters to send to the API endpoint
	...
	for the find config request scheduler operation.
...
// WithDefaults hydrates default values in the find config request scheduler params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRequestSchedulerParams) WithDefaults() *FindConfigRequestSchedulerParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config request scheduler params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRequestSchedulerParams) SetDefaults() {
