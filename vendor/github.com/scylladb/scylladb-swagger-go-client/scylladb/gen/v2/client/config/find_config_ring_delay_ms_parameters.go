...
FindConfigRingDelayMsParams contains all the parameters to send to the API endpoint
	...
	for the find config ring delay ms operation.
...
// WithDefaults hydrates default values in the find config ring delay ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRingDelayMsParams) WithDefaults() *FindConfigRingDelayMsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config ring delay ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRingDelayMsParams) SetDefaults() {
