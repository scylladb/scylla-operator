...
FindConfigRPCMaxThreadsParams contains all the parameters to send to the API endpoint
	...
	for the find config rpc max threads operation.
...
// WithDefaults hydrates default values in the find config rpc max threads params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRPCMaxThreadsParams) WithDefaults() *FindConfigRPCMaxThreadsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config rpc max threads params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRPCMaxThreadsParams) SetDefaults() {
