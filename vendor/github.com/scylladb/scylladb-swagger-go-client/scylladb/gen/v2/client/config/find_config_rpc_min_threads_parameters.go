...
FindConfigRPCMinThreadsParams contains all the parameters to send to the API endpoint
	...
	for the find config rpc min threads operation.
...
// WithDefaults hydrates default values in the find config rpc min threads params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRPCMinThreadsParams) WithDefaults() *FindConfigRPCMinThreadsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config rpc min threads params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigRPCMinThreadsParams) SetDefaults() {
