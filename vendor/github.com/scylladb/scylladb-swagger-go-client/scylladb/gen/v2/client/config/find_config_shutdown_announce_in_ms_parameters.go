...
FindConfigShutdownAnnounceInMsParams contains all the parameters to send to the API endpoint
	...
	for the find config shutdown announce in ms operation.
...
// WithDefaults hydrates default values in the find config shutdown announce in ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigShutdownAnnounceInMsParams) WithDefaults() *FindConfigShutdownAnnounceInMsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config shutdown announce in ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigShutdownAnnounceInMsParams) SetDefaults() {
