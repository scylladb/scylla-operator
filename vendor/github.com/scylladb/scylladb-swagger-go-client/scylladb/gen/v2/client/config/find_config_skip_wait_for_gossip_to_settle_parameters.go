...
FindConfigSkipWaitForGossipToSettleParams contains all the parameters to send to the API endpoint
	...
	for the find config skip wait for gossip to settle operation.
...
// WithDefaults hydrates default values in the find config skip wait for gossip to settle params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSkipWaitForGossipToSettleParams) WithDefaults() *FindConfigSkipWaitForGossipToSettleParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config skip wait for gossip to settle params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSkipWaitForGossipToSettleParams) SetDefaults() {
