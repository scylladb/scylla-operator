...
FindConfigSnapshotBeforeCompactionParams contains all the parameters to send to the API endpoint
	...
	for the find config snapshot before compaction operation.
...
// WithDefaults hydrates default values in the find config snapshot before compaction params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSnapshotBeforeCompactionParams) WithDefaults() *FindConfigSnapshotBeforeCompactionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config snapshot before compaction params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSnapshotBeforeCompactionParams) SetDefaults() {
