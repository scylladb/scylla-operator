...
FindConfigSstablePreemptiveOpenIntervalInMbParams contains all the parameters to send to the API endpoint
	...
	for the find config sstable preemptive open interval in mb operation.
...
// WithDefaults hydrates default values in the find config sstable preemptive open interval in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSstablePreemptiveOpenIntervalInMbParams) WithDefaults() *FindConfigSstablePreemptiveOpenIntervalInMbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config sstable preemptive open interval in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSstablePreemptiveOpenIntervalInMbParams) SetDefaults() {
