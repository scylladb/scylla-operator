...
FindConfigSstableSummaryRatioParams contains all the parameters to send to the API endpoint
	...
	for the find config sstable summary ratio operation.
...
// WithDefaults hydrates default values in the find config sstable summary ratio params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSstableSummaryRatioParams) WithDefaults() *FindConfigSstableSummaryRatioParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config sstable summary ratio params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigSstableSummaryRatioParams) SetDefaults() {
