...
FindConfigStoragePortParams contains all the parameters to send to the API endpoint
	...
	for the find config storage port operation.
...
// WithDefaults hydrates default values in the find config storage port params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigStoragePortParams) WithDefaults() *FindConfigStoragePortParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config storage port params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigStoragePortParams) SetDefaults() {
