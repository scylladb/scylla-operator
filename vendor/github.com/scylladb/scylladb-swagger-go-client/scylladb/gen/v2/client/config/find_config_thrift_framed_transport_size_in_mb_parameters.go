...
FindConfigThriftFramedTransportSizeInMbParams contains all the parameters to send to the API endpoint
	...
	for the find config thrift framed transport size in mb operation.
...
// WithDefaults hydrates default values in the find config thrift framed transport size in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigThriftFramedTransportSizeInMbParams) WithDefaults() *FindConfigThriftFramedTransportSizeInMbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config thrift framed transport size in mb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigThriftFramedTransportSizeInMbParams) SetDefaults() {
