...
FindConfigTombstoneWarnThresholdParams contains all the parameters to send to the API endpoint
	...
	for the find config tombstone warn threshold operation.
...
// WithDefaults hydrates default values in the find config tombstone warn threshold params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigTombstoneWarnThresholdParams) WithDefaults() *FindConfigTombstoneWarnThresholdParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config tombstone warn threshold params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigTombstoneWarnThresholdParams) SetDefaults() {
