...
FindConfigTruncateRequestTimeoutInMsParams contains all the parameters to send to the API endpoint
	...
	for the find config truncate request timeout in ms operation.
...
// WithDefaults hydrates default values in the find config truncate request timeout in ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigTruncateRequestTimeoutInMsParams) WithDefaults() *FindConfigTruncateRequestTimeoutInMsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config truncate request timeout in ms params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigTruncateRequestTimeoutInMsParams) SetDefaults() {
