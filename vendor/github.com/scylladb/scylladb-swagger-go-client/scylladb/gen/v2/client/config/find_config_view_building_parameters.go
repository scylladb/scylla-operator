...
FindConfigViewBuildingParams contains all the parameters to send to the API endpoint
	...
	for the find config view building operation.
...
// WithDefaults hydrates default values in the find config view building params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigViewBuildingParams) WithDefaults() *FindConfigViewBuildingParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config view building params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigViewBuildingParams) SetDefaults() {
