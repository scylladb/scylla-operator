...
FindConfigViewHintsDirectoryParams contains all the parameters to send to the API endpoint
	...
	for the find config view hints directory operation.
...
// WithDefaults hydrates default values in the find config view hints directory params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigViewHintsDirectoryParams) WithDefaults() *FindConfigViewHintsDirectoryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config view hints directory params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigViewHintsDirectoryParams) SetDefaults() {
