...
FindConfigVirtualDirtySoftLimitParams contains all the parameters to send to the API endpoint
	...
	for the find config virtual dirty soft limit operation.
...
// WithDefaults hydrates default values in the find config virtual dirty soft limit params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigVirtualDirtySoftLimitParams) WithDefaults() *FindConfigVirtualDirtySoftLimitParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find config virtual dirty soft limit params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindConfigVirtualDirtySoftLimitParams) SetDefaults() {
